...
// tabs, results-grid vehicle cards) - our dark blue instead of their orange,
// same real car data this already had.
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 md:mb-10">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
            Every car in our fleet is fully insured, regularly serviced, and ready for self-drive or chauffeured hire across Rwanda.
          </p>
        </div>
