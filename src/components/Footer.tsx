        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12 pb-12 border-b border-gray-800">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <span className="text-gray-400">(128+ Google reviews)</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-gray-400">
              Your trusted partner for car rentals in Kigali, Rwanda. Google Verified Business with 4.9★ rating. Quality vehicles, competitive rates, professional service.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+250796077321" className="text-gray-400 hover:text-[#4B5320] transition-colors">
                  +250 796 077 321
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="https://wa.me/250796077321" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#4B5320] transition-colors">
            ...
            <div className="flex gap-2 mt-6">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-gray-800 flex items-center justify-center hover:bg-[#4B5320] transition-colors group">
              ...
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-gray-800 flex items-center justify-center hover:bg-[#4B5320] transition-colors group">
                <svg className="w-4 h-4 text-gray-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                </svg>
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-gray-800 flex items-center justify-center hover:bg-[#4B5320] transition-colors group">
                <svg className="w-4 h-4 text-gray-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-gray-800 flex items-center justify-center hover:bg-[#4B5320] transition-colors group">
                <svg className="w-4 h-4 text-gray-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
              ...
              <p className="flex items-center gap-2">
                ...
                <a href="https://wa.me/250787619387" target="_blank" rel="noopener noreferrer" className="text-[#4B5320] hover:text-[#3a4218] transition-colors font-semibold">
                  Webtech Rwanda Ltd
                </a>
              </p>
            </div>
