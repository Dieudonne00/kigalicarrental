const reasons = [
  ...
  },
  {
    ...
    title: "Self-Drive or Chauffeur-Driven",
    description:
      "Choose to drive yourself around Rwanda or hire one of our professional local drivers — flexible Kigali car rental options built around your trip.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Here&apos;s what sets our Kigali car rental service apart.
          </p>
        </div>
