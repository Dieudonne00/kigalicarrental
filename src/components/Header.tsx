          ...
          <div className="flex justify-between items-center text-sm">
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span>Kigali Car Rental Support</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                <span>Kigali Car Rental Rates</span>
              </div>
            </div>
          ...
          <div className="mt-4 bg-white rounded-2xl border-2 border-blue-100 shadow-2xl p-4 max-h-[80vh] overflow-y-auto">
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl text-white shadow-lg">
              <div className="text-center">
                ...
                <div className="text-sm opacity-90 mt-1">Best Kigali Car Rental Rates</div>
                <Link
                  href="/book-now"
            ...
            <div className="mt-6 pt-4 border-t border-blue-100">
              <div className="text-center text-sm">
                <div className="font-bold text-blue-600 mb-2">24/7 Kigali Car Rental Support</div>
