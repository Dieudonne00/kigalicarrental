  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 bg-white p-2 rounded-lg border-2 border-gray-200 shadow-md"
      >
        <svg
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-40 h-screen w-64 bg-white border-r-2 border-gray-200 transition-transform ${
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="p-4 border-t-2 border-gray-200">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 rounded-lg font-bold text-sm text-red-600 hover:bg-red-50 transition-all"
            >
              <svg
                className="w-5 h-5"
                fill="none"
