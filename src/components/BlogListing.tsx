          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="relative flex-1">
              <input
                ...
                className="w-full px-4 py-3 pl-11 border border-gray-200 rounded-xl focus:border-[#1e3a8a] focus:outline-none focus:ring-2 focus:ring-[#1e3a8a]/10 bg-white shadow-sm text-gray-800 placeholder-gray-400"
              />
            ...
            <select
              ...
              className="px-4 py-3 border border-gray-200 rounded-xl focus:border-[#1e3a8a] focus:outline-none focus:ring-2 focus:ring-[#1e3a8a]/10 bg-white shadow-sm text-gray-700 sm:w-56"
            >
              {categories.map((c) => (
        ...
        {paginated.length > 0 ? (
              ...
              >
                <div className="md:flex">
                  <div className="relative h-64 md:h-auto md:w-1/2 md:min-h-[360px] overflow-hidden">
                    ...
                    <span className="absolute top-4 left-4 px-3 py-1 bg-[#1e3a8a] text-white text-xs font-bold rounded-full">
                  ...
                  <div className="p-6 md:p-10 md:w-1/2 flex flex-col justify-center">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 leading-tight group-hover:text-[#1e3a8a] transition-colors font-[family-name:var(--font-plus-jakarta)]">
                      {paginated[0].title}
                    </h2>
                    ...
                    <span className="inline-flex items-center gap-2 text-[#1e3a8a] font-semibold text-sm group-hover:gap-3 transition-all">
                      Read article
              ...
              {(currentPage === 1 && !searchQuery && selectedCategory === "all"
                ...
                >
                  ...
                  <div className="relative h-52 overflow-hidden shrink-0">
                    ...
                    <span className="absolute top-3 left-3 px-2.5 py-1 bg-[#1e3a8a] text-white text-xs font-bold rounded-full">
            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center gap-2 mt-12">
                <button
                  ...
                  className="px-4 py-2 border border-gray-200 rounded-lg text-sm font-semibold text-gray-600 hover:border-[#1e3a8a] hover:text-[#1e3a8a] transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  ← Prev
                </button>
          ...
          <div className="text-center py-20">
            ...
            <button
              ...
              className="px-6 py-3 bg-[#1e3a8a] text-white font-semibold rounded-xl hover:bg-[#172554] transition-all"
            >
              Clear Filters
            </button>
          </div>
