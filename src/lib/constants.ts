...
// Inline SVG fallback for car photos - a data URI never 404s, unlike a
// static file in /public that could itself go missing, and doesn't depend
// on any third-party host being up.
