// app/kigali-airport-car-rental/KigaliAirportCarRentalClient.tsx
"use client";
...
export default function KigaliAirportCarRentalClient() {
  ...
  return (
    <main className="pt-24 pb-16 bg-gray-50 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-[#1D4ED8] to-blue-800 text-white py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4">
              <div className="w-12 h-12 bg-[#1D4ED8]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-[#1D4ED8] font-bold text-xl">1</span>
              </div>
            ...
            <div className="text-center p-4">
              <div className="w-12 h-12 bg-[#1D4ED8]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-[#1D4ED8] font-bold text-xl">2</span>
              </div>
            ...
            <div className="text-center p-4">
              <div className="w-12 h-12 bg-[#1D4ED8]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-[#1D4ED8] font-bold text-xl">3</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="relative">
                <input
                  ...
                  className="w-full sm:w-64 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1D4ED8]"
                />
              ...
              <select
                ...
                className="px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1D4ED8] bg-white"
              >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filteredCars.map((car) => (
                <div
                  key={car.id}
                  className="bg-white rounded-xl overflow-hidden border border-gray-200 hover:border-[#1D4ED8] hover:shadow-xl transition-all duration-300"
                >
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-3 right-3">
                      <span className="inline-block px-3 py-1 bg-[#1D4ED8] text-white rounded-full text-xs font-bold">
                        {car.category}
                      </span>
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        className="flex-1 bg-gradient-to-r from-[#1D4ED8] to-blue-700 text-white text-center px-4 py-3 rounded-lg font-bold hover:shadow-lg transition-shadow"
                      >
                        Book Airport Pickup
                      </button>
                      <Link
                        href={`/cars/${car.id}?pickup=airport`}
                        className="flex-1 border-2 border-[#1D4ED8] text-[#1D4ED8] text-center px-4 py-3 rounded-lg font-bold hover:bg-[#1D4ED8] hover:text-white transition-colors flex items-center justify-center"
                      >
                        Details
                      </Link>
                    </div>
        ...
        {cars.length === 0 && !loading && (
          <div className="text-center py-12 bg-white rounded-xl shadow mt-8">
            ...
            <a href="tel:+250787619387" className="text-[#1D4ED8] font-bold hover:underline">
              +250 787 619 387
            </a>
          </div>
        )}
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 bg-[#1D4ED8]/10 rounded-full flex items-center justify-center flex-shrink-0">
      ...
      {/* CTA Section */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-gradient-to-r from-[#1D4ED8] to-blue-800 rounded-2xl p-8 md:p-12 text-white">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  ...
                  className="bg-white text-[#1D4ED8] px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition-colors text-center"
                >
                  Book Airport Pickup
                </Link>
                <a
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <a href="tel:+250787619387" className="text-lg hover:underline">
                    +250 787 619 387
                  </a>
                </div>
                <div>
