// app/land-cruiser-rental-rwanda/page.tsx
"use client";
...
export default function LandCruiserRentalRwanda() {
  ...
  return (
    <>
      <Head>
        <title>Land Cruiser Rental Rwanda | Toyota Land Cruiser Prado, V8 & 300 Series for Safari | Gorilla Trekking Vehicles</title>
        <meta name="description" content="✅ Land Cruiser rental Rwanda - Toyota Land Cruiser Prado, V8, 300 Series & 200 Series for safari and off-road adventures. Pop-up roofs, camping gear, snorkel equipped. Perfect for Akagera, Volcanoes & Nyungwe National Parks. Book your Land Cruiser today." />
        <meta name="keywords" content="land cruiser rental Rwanda, Toyota Land Cruiser hire Kigali, Land Cruiser Prado rental, Land Cruiser V8 Rwanda, Land Cruiser 300 series rental, Toyota Land Cruiser safari vehicle, Land Cruiser for gorilla trekking, Land Cruiser Akagera, Land Cruiser Volcanoes National Park, Land Cruiser Nyungwe, 4x4 Land Cruiser Rwanda, off-road Land Cruiser hire, luxury Land Cruiser rental, 7 seater Land Cruiser, 8 seater Land Cruiser, diesel Land Cruiser Rwanda, automatic Land Cruiser, Land Cruiser with pop-up roof, Land Cruiser with roof tent, safari ready Land Cruiser, camping equipped Land Cruiser, Land Cruiser with snorkel, bull bar Land Cruiser, winch equipped Land Cruiser, recovery kit Land Cruiser, Land Cruiser for self-drive safari, guided safari Land Cruiser, best Land Cruiser rental Rwanda, affordable Land Cruiser hire, luxury Land Cruiser safari" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://kigalicarrental.site/land-cruiser-rental-rwanda" />
        <meta property="og:title" content="Land Cruiser Rental Rwanda | Toyota Land Cruiser Prado, V8 & 300 Series for Safari" />
        <meta property="og:description" content="Toyota Land Cruiser rental for safari and off-road adventures. Pop-up roofs, camping gear, snorkel equipped. Perfect for national parks." />
        ...
        <meta property="twitter:url" content="https://kigalicarrental.site/land-cruiser-rental-rwanda" />
        <meta property="twitter:title" content="Land Cruiser Rental Rwanda | Toyota Land Cruiser for Safari" />
        <meta property="twitter:description" content="Toyota Land Cruiser rental for safari and off-road adventures. Pop-up roofs, camping gear, snorkel equipped." />
        <meta property="twitter:image" content="https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=1200" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://kigalicarrental.site/land-cruiser-rental-rwanda" />
        ...
        <meta name="author" content="Kigali Car Rental - Land Cruiser Specialists" />
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                <span className="text-[#D0D98D]">Land Cruiser</span> Rental Rwanda
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
                <span className="text-[#D0D98D] font-semibold">Toyota Land Cruiser</span> Prado, V8, 300 Series & 200 Series 
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                ...
                <div className="bg-[#4B5320]/40 backdrop-blur-sm rounded-xl p-4 border border-[#D0D98D]/30">
                  <div className="text-2xl font-bold text-[#D0D98D]">5</div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  Land Cruiser Hotline: +250 796 077 321
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Land Cruiser <span className="text-[#4B5320]">Safari Packages</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320]/20 p-8 hover:border-[#4B5320] hover:shadow-xl transition-all group">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$135</span>
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320]/20 p-8 hover:border-[#4B5320] hover:shadow-xl transition-all group">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$225</span>
                <span className="text-gray-500">/day</span>
              </div>
              <ul className="space-y-3 mb-8 text-gray-600">
                <li className="flex items-center gap-2">
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-600">
                  <span className="font-bold text-[#4B5320] text-lg">{filteredVehicles.length}</span> Land Cruisers available
                </span>
                <button
                  onClick={() => {
              ...
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                    Land Cruiser <span className="text-[#4B5320]">Fleet</span>
                  </h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Why Choose <span className="text-[#D0D98D]">Land Cruiser</span> for Your Safari
              </h2>
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Land Cruiser Rental Rwanda - <span className="text-[#4B5320]">FAQ</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Land Cruiser <span className="text-[#4B5320]">Model Comparison</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                What Our <span className="text-[#4B5320]">Land Cruiser Guests Say</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
