...
export const metadata: Metadata = {
  title: "Self Drive Rwanda | Self Drive Car Hire Kigali - Kigali Car Hire",
  ...
  keywords: "self drive rwanda, self drive car hire kigali, self drive kigali, rent a car self drive rwanda, self drive car rental kigali, self drive 4x4 rwanda",
  alternates: { canonical: "https://kigalicarhire.rw/self-drive-rwanda" },
  openGraph: {
    title: "Self Drive Rwanda | Kigali Car Hire",
    description: "Self drive car hire in Rwanda from $30/day. Fully insured, 24/7 support. Explore Rwanda your way.",
    url: "https://kigalicarhire.rw/self-drive-rwanda",
  },
};
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-br from-gray-900 to-[#01B000]/80 text-white py-20 md:py-32">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <span className="inline-block bg-[#01B000] text-white text-sm font-bold px-4 py-1 rounded-full mb-6">Explore Rwanda Your Way</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/fleet" className="bg-[#01B000] text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-[#019500] transition-all">Browse Cars</Link>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          <div className="grid md:grid-cols-2 gap-10 mb-16">
            <div>
              ...
              <p className="text-gray-600 mb-4">Kigali Car Hire offers the widest range of self drive vehicles in Rwanda. From budget-friendly economy cars for city driving to robust 4x4 Land Cruisers for national park adventures, we have the right car for every journey.</p>
              ...
              <Link href="/fleet" className="inline-block bg-[#01B000] text-white px-6 py-3 rounded-lg font-bold hover:bg-[#019500] transition-all">View All Cars</Link>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={dest.name} className="border border-gray-100 rounded-lg p-4">
                  ...
                  <p className="text-[#01B000] text-sm font-semibold mb-1">{dest.dist}</p>
          ...
          <div className="bg-[#01B000] rounded-2xl p-10 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/fleet" className="bg-white text-[#01B000] px-8 py-4 rounded-lg font-bold hover:bg-gray-100 transition-all">Browse Cars</Link>
