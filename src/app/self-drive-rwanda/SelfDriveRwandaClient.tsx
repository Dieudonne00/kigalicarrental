    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500 text-white rounded-full text-sm font-bold mb-6 shadow-lg">
          ...
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-8">
            Explore the Land of a Thousand Hills <span className="font-bold text-blue-400">at your own pace</span>.
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="#fleet"
              className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl text-lg"
            >
            ...
            <div className="bg-white rounded-xl border-2 border-gray-200 p-6 sticky top-24 shadow-md">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        include4x4 ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-500"
                      }`}>
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                      include4x4 ? "bg-blue-500 border-blue-500" : "border-gray-300"
                    }`}>
                      {include4x4 && (
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="absolute w-full accent-blue-500 pointer-events-auto"
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <Link href="/how-it-works" className="text-xs text-blue-600 font-bold hover:underline mt-2 inline-block">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-sm text-gray-600">
                  <span className="text-3xl font-bold text-blue-600">{filteredCars.length}</span> self drive vehicles
                </p>
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">
                  Self Drive Fleet <span className="text-blue-600">${priceRange[0]} - ${priceRange[1]}/day</span>
                </h2>
              ...
              {filteredCars.map((car) => (
                ...
                >
                  ...
                  <div className="relative h-48 bg-gray-100 overflow-hidden">
                    ...
                    {/* SELF DRIVE BADGE */}
                    <div className="absolute top-3 right-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-3 py-1.5 rounded-full text-xs font-bold flex items-center gap-1 shadow-lg">
                  ...
                  <div className="p-6">
                      ...
                      <div>
                        ...
                        {car.weeklyRate && (
                          <div className="text-xs text-gray-500 mt-1">
                            <span className="font-bold text-blue-600">${car.weeklyRate}/week</span> • Save 15%
                          </div>
                        )}
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <Link
                        ...
                        className="flex items-center justify-center px-4 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg font-bold hover:from-blue-600 hover:to-blue-700 transition-all text-sm"
                      >
