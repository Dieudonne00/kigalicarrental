// app/rooftop-tent-car-rental-rwanda/page.tsx
"use client";
...
export default function RooftopTentCarRentalRwanda() {
  ...
  return (
    <>
      <Head>
        <title>Rooftop Tent Car Rental Rwanda | Overland Camping Vehicles for Safari | Land Cruiser & Hilux with Roof Tent</title>
        <meta name="description" content="✅ Rooftop tent car rental Rwanda - Complete overland camping vehicles for safari adventures. Toyota Land Cruiser, Hilux, Land Rover with roof tents. Includes awnings, fridges, solar panels, cooking equipment. Perfect for Akagera, Lake Kivu, cross-border expeditions. Book your camping vehicle today." />
        <meta name="keywords" content="rooftop tent car rental Rwanda, roof tent vehicle hire Kigali, camping car rental Rwanda, overland vehicle rental, 4x4 with rooftop tent, Land Cruiser with roof tent, Hilux with rooftop tent, Land Rover roof tent, camping equipped vehicle, self-drive camping safari, Akagera camping vehicle, Lake Kivu camping car, cross-border camping rental, roof top tent hire Rwanda, awning equipped vehicle, fridge equipped 4x4, solar panel camping car, battery system camping, sleeping capacity 4x4, family camping vehicle, adventure camping rental, overland expedition vehicle, rooftop tent installation, pop-up roof tent, hard shell roof tent, soft shell roof tent, camping gear included" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://kigalicarrental.site/rooftop-tent-car-rental-rwanda" />
        <meta property="og:title" content="Rooftop Tent Car Rental Rwanda | Overland Camping Vehicles for Safari" />
        <meta property="og:description" content="Complete overland camping vehicles with roof tents for safari adventures. Land Cruiser, Hilux with awnings, fridges, solar panels." />
        <meta property="og:image" content="https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?auto=format&fit=crop&w=1200" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://kigalicarrental.site/rooftop-tent-car-rental-rwanda" />
        <meta property="twitter:title" content="Rooftop Tent Car Rental Rwanda | Overland Camping Vehicles" />
        <meta property="twitter:description" content="Complete overland camping vehicles with roof tents for safari adventures." />
        <meta property="twitter:image" content="https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?auto=format&fit=crop&w=1200" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://kigalicarrental.site/rooftop-tent-car-rental-rwanda" />
        ...
        <meta name="author" content="Kigali Car Rental - Overland Camping Specialists" />
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                <span className="text-[#D0D98D]">Rooftop Tent</span> Car Rental Rwanda
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
                <span className="text-[#D0D98D] font-semibold">Complete overland camping vehicles</span> for 
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                ...
                <div className="bg-[#4B5320]/40 backdrop-blur-sm rounded-xl p-4 border border-[#D0D98D]/30">
                  <div className="text-2xl font-bold text-[#D0D98D]">2-5</div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  Camping Hotline: +250 796 077 321
                </a>
              </div>
            </div>
          </div>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-full transition-all ${
                    selectedPark === park.id
                      ? "bg-[#D0D98D] text-[#4B5320]"
                      : "text-white hover:bg-[#4B5320]/60 border border-[#D0D98D]/30"
                  }`}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Rooftop Tent <span className="text-[#4B5320]">Camping Packages</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320] p-8 hover:shadow-2xl transition-all group relative overflow-hidden">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$245</span>
                <span className="text-gray-500">/day</span>
              </div>
              <ul className="space-y-3 mb-8 text-gray-600">
                <li className="flex items-center gap-2">
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-600">
                  <span className="font-bold text-[#4B5320] text-lg">{filteredVehicles.length}</span> rooftop tent vehicles available
                </span>
                <button
                  onClick={() => {
              ...
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                    Rooftop Tent <span className="text-[#4B5320]">Camping Fleet</span>
                  </h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Why Choose <span className="text-[#D0D98D]">Rooftop Tent Camping</span> in Rwanda
              </h2>
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Rooftop Tent Car Rental - <span className="text-[#4B5320]">FAQ</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Complete <span className="text-[#4B5320]">Camping Gear</span> Included
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                What Our <span className="text-[#4B5320]">Camping Guests Say</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
