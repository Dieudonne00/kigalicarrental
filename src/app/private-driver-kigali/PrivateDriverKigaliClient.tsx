    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full text-sm font-bold mb-6 shadow-lg">
          ...
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-8">
            <span className="font-bold text-blue-300">Executive class</span> chauffeur service.
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="#fleet"
              className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg hover:shadow-xl text-lg"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* PRIVATE DRIVER VS ONE-OFF HIRE - CONTEXT SECTION */}
        <div className="bg-white rounded-2xl border border-gray-200 p-8 md:p-10">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
            A Dedicated Driver, Not a Different One Each Trip
          </h2>
          <p className="text-gray-600 leading-relaxed mb-4">
            "Private driver" on this page means something specific: you keep the same person for the length of your stay, or on a standing
            daily or weekly retainer, rather than whoever the dispatch queue assigns for a single booking. That distinction matters more than
            it sounds. A driver who picks you up every morning for two weeks stops needing directions repeated, learns which entrance you
            actually use at your office or residence, works out which routes to avoid at which time of day, and remembers how you like to
            work in the car — quiet, on calls, or ready to talk. None of that builds up over a one-off trip.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            That's why this service is used mostly by NGO and embassy staff on posting, diplomats, and business travelers running a
            multi-week program in Kigali — people for whom consistency and discretion matter as much as the driving itself. A retained
            driver who already knows not to make small talk during a call, doesn't need the same instructions twice, and can be trusted
            with a house key or an office badge is a different working relationship than booking a new driver for every trip.
          </p>
          <p className="text-gray-600 leading-relaxed">
            If you only need a car and driver for a single airport run, one day of meetings, or a short city tour, our{" "}
            <Link href="/driver-car-hire-kigali" className="text-blue-600 font-semibold hover:underline">
              standard driver car hire
            </Link>{" "}
            page is the simpler option for that. Come here when you want the same driver retained for your whole stay.
          </p>
        </div>
      </div>
            ...
            <div className="bg-white rounded-xl border-2 border-gray-200 p-6 sticky top-24 shadow-md">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        includeLuxury ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-500"
                      }`}>
                    ...
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                      includeLuxury ? "bg-blue-500 border-blue-500" : "border-gray-300"
                    }`}>
                      {includeLuxury && (
                    ...
                    <div>
                      ...
                      <ul className="text-xs text-gray-600 mt-2 space-y-1">
                        <li className="flex items-center gap-1">
                          <span className="text-blue-600">•</span> Professional English-speaking driver
                        </li>
                        <li className="flex items-center gap-1">
                          <span className="text-blue-600">•</span> Bottled water & WiFi
                        </li>
                        <li className="flex items-center gap-1">
                          <span className="text-blue-600">•</span> Flight tracking included
                        </li>
                        <li className="flex items-center gap-1">
                          <span className="text-blue-600">•</span> All taxes & insurance
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-sm text-gray-600">
                  <span className="text-3xl font-bold text-blue-600">{filteredCars.length}</span> chauffeur vehicles
                </p>
          ...
          <>
            <div className="flex justify-between items-center mb-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">
                  Private Driver Fleet <span className="text-blue-600">${priceRange[0]} - ${priceRange[1]}/day</span>
                </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
              {filteredCars.map((car) => (
                <div
                  key={car.id}
                  className="group bg-white rounded-xl border-2 border-gray-200 overflow-hidden hover:border-blue-500 transition-all hover:shadow-xl"
                >
                  {/* Car Image */}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-baseline justify-between mb-5">
                      <div>
                        <div className="flex items-baseline gap-1">
                          <span className="text-3xl font-bold text-blue-600">${car.dailyRate}</span>
                          <span className="text-sm text-gray-500 ml-1">/day</span>
                        </div>
                        <p className="text-xs text-gray-500 mt-1">
                          <span className="font-bold text-blue-600">Includes professional driver</span>
                        </p>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <Link
                        ...
                        className="flex items-center justify-center px-4 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-bold hover:from-blue-700 hover:to-indigo-700 transition-all text-sm"
                      >
                      ...
                      <Link
                        ...
                        className="flex items-center justify-center px-4 py-3 border-2 border-blue-500 text-blue-600 rounded-lg font-bold hover:bg-blue-50 transition-all text-sm"
                      >
                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
                  ...
                  <div className="mt-4 pt-4 border-t border-white/20">
                    <p className="text-sm text-white/80">
                      <span className="font-bold text-blue-300">24/7 Dispatch:</span> +250 787 619 387
                    </p>
                  </div>
                </div>
              </div>
