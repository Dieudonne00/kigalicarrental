...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Our Story Section */}
      <section id="our-story" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
      ...
      <section id="our-team" className="bg-white py-8 md:py-16">
      ...
      <section id="why-us" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
