    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-[#1D4ED8] to-[#1E3A8A] rounded-2xl p-8 text-white">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="bg-white border-2 border-gray-200 p-6 rounded-xl hover:border-[#1D4ED8] transition-all">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={i}>
              <div className="text-5xl font-bold text-[#1D4ED8]">{num}</div>
      ...
      {/* CTA */}
      <section className="bg-gradient-to-r from-[#1D4ED8] to-[#1E3A8A] py-16 text-white text-center">
        ...
        <a
          href="/fleet"
          className="inline-block px-8 py-4 bg-white text-[#1D4ED8] font-bold rounded-lg hover:bg-gray-100 transition-all"
        >
          Browse Our Fleet
        </a>
      </section>
