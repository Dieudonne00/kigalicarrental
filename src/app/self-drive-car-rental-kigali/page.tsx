...
export const metadata: Metadata = {
  ...
  description:
    "Self drive car rental in Kigali. Rent a car without driver and explore Rwanda freely - economy cars, SUVs, and 4x4s with unlimited mileage and free delivery.",
  alternates: {
