    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                <span className="text-[#93C5FD]">4x4 Car Rental</span> Rwanda
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
                Specialized <span className="text-[#93C5FD] font-semibold">off-road vehicles</span> for 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              4x4 Safari <span className="text-[#1D4ED8]">Packages</span>
            </h2>
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-600">
                  <span className="font-bold text-[#1D4ED8] text-lg">{filteredVehicles.length}</span> 4x4 vehicles available
                </span>
                <button
                  onClick={() => {
              ...
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                    4x4 <span className="text-[#1D4ED8]">Safari Fleet</span>
                  </h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Why Choose Our <span className="text-[#93C5FD]">4x4 Rental</span> in Rwanda
              </h2>
            ...
            <div className="max-w-3xl mx-auto mb-12 space-y-4 text-gray-200 leading-relaxed">
              <p>
                Rwanda is the &quot;Land of a Thousand Hills&quot; for a reason, and the road network reflects it:
                the paved highways connecting Kigali to the provinces are in good shape, but the roads in and
                around the national parks are a different story. A 4x4 matters most where the tarmac ends — on the
                unpaved approach roads to park headquarters and lodges, on the game-drive tracks inside Akagera
                (where 2WD vehicles are generally impractical and often not permitted), and on the steep,
                frequently muddy routes up toward the Volcanoes National Park trailheads. During the rainy seasons
                (roughly March–May and September–November) those same roads turn slick and rutted, which is when
                the difference between a 4x4 and a standard car is most obvious.
              </p>
              <p>
                If your trip is Kigali city driving only, a 4x4 isn&apos;t strictly necessary — most people renting
                one from us are doing so specifically because their itinerary includes a national park or a rural
                lodge. That&apos;s also why our fleet spans different capability levels: a Hilux or Pajero is
                enough for most park access roads, while a Land Cruiser or Defender is the better choice for
                serious off-road tracks, multi-day camping routes, or river crossings where ground clearance and
                low-range gearing really earn their keep.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Rwanda's National Parks - <span className="text-[#1D4ED8]">4x4 Required</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 hover:border-[#1D4ED8] transition-all">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-16 h-16 bg-[#1D4ED8]/10 rounded-full flex items-center justify-center text-3xl">
                  🦁
                </div>
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Akagera National Park</h3>
                  <p className="text-[#1D4ED8] font-semibold">2.5 hrs from Kigali</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 hover:border-[#1D4ED8] transition-all">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-[#1D4ED8] font-semibold">5 hrs from Kigali</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 hover:border-[#1D4ED8] transition-all">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-[#1D4ED8] font-semibold">3 hrs from Kigali</p>
                </div>
              </div>
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                4x4 Car Rental Rwanda - <span className="text-[#1D4ED8]">FAQ</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              What Our <span className="text-[#1D4ED8]">Safari Clients Say</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
