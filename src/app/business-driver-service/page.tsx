...
export default function BusinessDriverService() {
  ...
  return (
    <>
      <Head>
        <title>Business Driver Service Kigali | Executive Chauffeur for Corporate Travel Rwanda</title>
        <meta name="description" content="✅ Business driver service Kigali - Professional executive chauffeurs for corporate clients. Airport transfers, meeting transport, conference shuttles. Luxury vehicles, uniformed drivers, WiFi, flight tracking. Corporate accounts welcome." />
        <meta name="keywords" content="business driver service Kigali, executive chauffeur Rwanda, corporate driver Kigali, business travel chauffeur, corporate airport transfer Kigali, executive meeting transport, conference shuttle service Rwanda, corporate car service Kigali, VIP chauffeur Rwanda, business executive driver, corporate account chauffeur, luxury business vehicle Kigali, professional driver for executives, company driver service Rwanda, corporate transportation Kigali, business meeting chauffeur, embassy driver service Kigali, NGO driver Rwanda, international business traveler chauffeur, CEO driver Kigali, executive sedan service, luxury SUV with driver, corporate event transport, business hotel transfer Kigali, Kigali business districts driver" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://kigalicarrental.site/business-driver-service" />
        <meta property="og:title" content="Business Driver Service Kigali | Executive Chauffeur for Corporate Travel" />
        <meta property="og:description" content="Professional executive chauffeurs for corporate clients. Airport transfers, meeting transport, conference shuttles. Luxury vehicles, uniformed drivers." />
        ...
        <meta property="twitter:url" content="https://kigalicarrental.site/business-driver-service" />
        <meta property="twitter:title" content="Business Driver Service Kigali | Executive Chauffeur for Corporate Travel" />
        <meta property="twitter:description" content="Professional executive chauffeurs for corporate clients. Airport transfers, meeting transport, conference shuttles." />
        <meta property="twitter:image" content="https://images.unsplash.com/photo-1557174361-f9d9a1f6c5b1?auto=format&fit=crop&w=1200" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://kigalicarrental.site/business-driver-service" />
        ...
        <meta name="author" content="Kigali Car Rental - Business Driver Service" />
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
            <div className="max-w-4xl">
              ...
              <div className="flex items-center gap-2 text-sm text-[#D0D98D] mb-6">
                ...
                <span>›</span>
                <Link href="/business-services" className="hover:text-white transition-colors">Business Services</Link>
                <span>›</span>
                <span className="text-white">Business Driver Service</span>
              </div>
              
              <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                <span className="text-[#D0D98D]">Business Driver</span> Service Kigali
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
                Professional <span className="text-[#D0D98D] font-semibold">executive chauffeurs</span> for corporate clients. 
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                ...
                <div className="bg-[#4B5320]/40 backdrop-blur-sm rounded-xl p-4 border border-[#D0D98D]/30">
                  <div className="text-2xl font-bold text-[#D0D98D]">6</div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  Corporate Desk: +250 796 077 321
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Corporate <span className="text-[#4B5320]">Driver Packages</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320] p-8 hover:shadow-2xl transition-all group relative overflow-hidden">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$220</span>
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320]/20 p-8 hover:border-[#4B5320] hover:shadow-xl transition-all group">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$2,800</span>
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-600">
                  <span className="font-bold text-[#4B5320] text-lg">{filteredVehicles.length}</span> executive vehicles available
                </span>
                <button
                  onClick={() => {
              ...
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                    Executive <span className="text-[#4B5320]">Chauffeur Fleet</span>
                  </h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Why Choose Our <span className="text-[#D0D98D]">Business Driver Service</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Business Driver Service - <span className="text-[#4B5320]">FAQ</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              What Our <span className="text-[#4B5320]">Corporate Clients Say</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
