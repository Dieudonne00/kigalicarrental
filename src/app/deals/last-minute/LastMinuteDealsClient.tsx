  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-[#1D4ED8]/95 to-[#172554]/95"></div>
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-[#1D4ED8] font-bold rounded-lg hover:bg-gray-100 transition-all shadow-lg border-2 border-[#1D4ED8]"
            >
              <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-gradient-to-r from-[#1D4ED8] to-[#172554] py-4 relative overflow-hidden border-y border-yellow-400/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" id="deals">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-72 flex-shrink-0">
            <div className="bg-white rounded-xl border-2 border-[#1D4ED8]/20 p-6 sticky top-24 shadow-md">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#1D4ED8]/5 border border-[#1D4ED8]/20 rounded-lg p-3">
          ...
          <div className="flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                  {filteredCars.map((car) => (
                    ...
                    >
                      ...
                      {/* FLAGSHIP BADGE */}
                      <div className="absolute top-0 right-0 bg-[#1D4ED8] text-white px-4 py-2 rounded-bl-xl z-10 font-bold flex items-center gap-1">
                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
                        </svg>
                        FLAGSHIP
                      ...
                      <div className="relative h-48 bg-gray-100 overflow-hidden">
                        ...
                        {/* AVAILABLE NOW */}
                        <div className="absolute bottom-3 left-3 bg-blue-600 text-white px-3 py-1.5 rounded-full text-xs font-bold shadow-lg flex items-center gap-1">
                      ...
                      <div className="p-6">
                        ...
                        <div className="mb-4 py-3 border-y border-gray-100">
                          <div className="flex items-baseline justify-between">
                            ...
                            <div className="text-right">
                              ...
                              <div className="text-xs text-[#1D4ED8] font-bold mt-1">
                                Premium +40%
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="flex gap-2 mb-4">
                          ...
                          <span className="bg-[#1D4ED8]/10 text-[#1D4ED8] text-[10px] px-2 py-1 rounded-full font-bold flex items-center gap-1">
                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {!loading && filteredCars.length > 0 && (
              <div className="mt-16">
                <div className="bg-gradient-to-r from-[#1D4ED8] to-[#172554] rounded-2xl p-8 md:p-12 text-white border border-yellow-400/20">
                  ...
                  <div className="text-center mt-8">
                    <a
                      href="tel:+250787619387"
                      className="inline-flex items-center px-6 py-3 bg-yellow-500 text-[#1D4ED8] rounded-lg font-bold hover:bg-yellow-400 transition-all"
                    >
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      Flagship Concierge: +250 787 619 387
                    </a>
                  </div>
                </div>
              </div>
