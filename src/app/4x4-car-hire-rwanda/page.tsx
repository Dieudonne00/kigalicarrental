...
export const metadata: Metadata = {
  title: "4x4 Car Hire Rwanda | 4x4 Rental Kigali Land Cruiser Prado - Kigali Car Hire",
  ...
  keywords: "4x4 car hire rwanda, 4x4 rental kigali, land cruiser hire rwanda, land cruiser prado rental kigali, 4x4 hire rwanda safari, 4wd car hire kigali, four wheel drive rental rwanda",
  alternates: { canonical: "https://kigalicarhire.rw/4x4-car-hire-rwanda" },
  openGraph: {
    title: "4x4 Car Hire Rwanda | Land Cruiser and Prado Rental - Kigali Car Hire",
    description: "Hire a 4x4 in Rwanda from $80/day. Land Cruiser, Prado, RAV4. Ideal for safaris and national parks.",
    url: "https://kigalicarhire.rw/4x4-car-hire-rwanda",
  },
};
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "Kigali Car Hire offers Toyota Land Cruiser, Toyota Land Cruiser Prado, Toyota RAV4, Toyota Fortuner, and Mitsubishi Pajero. All 4x4 vehicles are well maintained and come with full insurance and 24/7 roadside assistance." },
    },
    {
      "@type": "Question",
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-br from-gray-800 to-[#01B000]/70 text-white py-20 md:py-32">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <span className="inline-block bg-[#01B000] text-white text-sm font-bold px-4 py-1 rounded-full mb-6">Safari Ready Vehicles</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/book-now" className="bg-[#01B000] text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-[#019500] transition-all">Book a 4x4</Link>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {[
              ...
              <div key={car.title} className="bg-white rounded-xl border-2 border-gray-200 p-6">
                ...
                <p className="text-[#01B000] font-bold mb-3">{car.price}</p>
                <p className="text-gray-600 text-sm mb-4">{car.desc}</p>
                <Link href="/book-now" className="block w-full text-center bg-[#01B000] text-white py-2 rounded-lg font-bold hover:bg-[#019500] transition-all text-sm">Book This Vehicle</Link>
              </div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 mb-16">
            <div>
              ...
              <p className="text-gray-600 mb-6">All Kigali Car Hire 4x4 vehicles are regularly serviced, fully insured, and come with a spare tyre, jack, and emergency kit. Our 24/7 roadside assistance means you are never stranded.</p>
              <div className="space-y-3">
                {["Full insurance included", "Unlimited mileage", "24/7 roadside assistance", "Free delivery in Kigali", "Spare tyre and emergency kit", "GPS available on request"].map((feature) => (
                  <div key={feature} className="flex items-center gap-2">
                    <svg className="w-5 h-5 text-[#01B000] flex-shrink-0" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M5 13l4 4L19 7" /></svg>
          ...
          <div className="bg-[#01B000] rounded-2xl p-10 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/book-now" className="bg-white text-[#01B000] px-8 py-4 rounded-lg font-bold hover:bg-gray-100 transition-all">Book Now</Link>
              <a href="https://wa.me/250788892976" target="_blank" rel="noopener noreferrer" className="border-2 border-white text-white px-8 py-4 rounded-lg font-bold hover:bg-white hover:text-[#01B000] transition-all">WhatsApp Us</a>
            </div>
          </div>
        </div>
      </div>
