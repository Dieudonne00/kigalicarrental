...
export default function MonthlyRentalClient() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#1D4ED8] to-[#1E40AF] text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-3">
              <a 
                ...
                className="px-5 py-2.5 bg-[#1D4ED8] text-white rounded-lg font-semibold hover:bg-[#1E40AF] transition-colors text-sm"
              >
                Call Monthly Desk
              </a>
              <Link
                href="/contact"
                className="px-5 py-2.5 border border-[#1D4ED8] text-[#1D4ED8] rounded-lg font-semibold hover:bg-[#1D4ED8]/5 transition-colors text-sm"
              >
                Request Quote
              </Link>
            </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm text-gray-500">
                <span className="font-bold text-[#1D4ED8]">{filteredVehicles.length}</span> vehicles available
              </span>
              <select
                value={selectedCategory}
                onChange={(e) => setSelectedCategory(e.target.value)}
                className="px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1D4ED8] focus:border-transparent bg-white"
              >
                {categories.map(cat => (
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-12 text-center shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <button
                ...
                className="px-6 py-2 bg-[#1D4ED8] text-white rounded-lg font-medium hover:bg-[#1E40AF] transition-colors"
              >
                Reset Filters
              </button>
              <a
                href="tel:+250787619387"
                className="px-6 py-2 border border-[#1D4ED8] text-[#1D4ED8] rounded-lg font-medium hover:bg-[#1D4ED8]/5 transition-colors"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredVehicles.map((vehicle) => {
              ...
              return (
                <div
                  key={vehicle.id}
                  className="group bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-[#1D4ED8] hover:shadow-lg transition-all duration-300"
                >
                  {/* IMAGE SECTION */}
                  <div className="relative h-48 bg-gray-100">
                    ...
                    {/* AVAILABILITY BADGE */}
                    {vehicle.available ? (
                      <div className="absolute top-4 left-4 bg-blue-500 text-white text-xs px-2.5 py-1.5 rounded-full font-medium flex items-center gap-1 shadow-md">
                    ...
                    {/* SAVINGS BUBBLE */}
                    {savingsPercent > 0 && (
                      <div className="absolute bottom-4 right-4 bg-[#1D4ED8] text-white text-sm font-bold px-3 py-1.5 rounded-full shadow-md">
                        Save {savingsPercent}%
                      </div>
                    )}
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <Link
                        ...
                        className="flex items-center justify-center px-4 py-3 bg-[#1D4ED8] text-white text-sm font-semibold rounded-lg hover:bg-[#1E40AF] transition-colors"
                      >
                        Select Plan
                      </Link>
                      <Link
