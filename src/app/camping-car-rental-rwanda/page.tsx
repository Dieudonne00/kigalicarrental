// app/camping-car-rental-rwanda/page.tsx
"use client";
...
export default function CampingCarRentalRwanda() {
  ...
  return (
    <>
      <Head>
        <title>Camping Car Rental Rwanda | Self-Contained Campervans & Motorhomes for Safari | Akagera & Lake Kivu</title>
        <meta name="description" content="✅ Camping car rental Rwanda - Self-contained campervans and motorhomes for safari adventures. Complete kitchen, toilet, shower, fridge. Sleep 2-6 persons. Perfect for Akagera, Lake Kivu, cross-border expeditions. Book your home on wheels today." />
        <meta name="keywords" content="camping car rental Rwanda, campervan hire Kigali, motorhome rental Rwanda, RV rental Rwanda, self-contained camper, camping vehicle with toilet, camper with shower, kitchen equipped camper, fridge in camper, sleeping capacity 4x4, Akagera camping car, Lake Kivu motorhome, cross-border campervan, 4x4 camper rental, luxury RV Rwanda, family camping vehicle, overland camper, safari campervan, camping car with awning, solar panel camper, battery system camper, water tank camping car, waste tank camper, outdoor shower camper, roof vent camper, heating in camper, inverter camper, camping car for hire Rwanda" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://kigalicarrental.site/camping-car-rental-rwanda" />
        <meta property="og:title" content="Camping Car Rental Rwanda | Self-Contained Campervans & Motorhomes for Safari" />
        <meta property="og:description" content="Self-contained campervans and motorhomes for safari adventures. Complete kitchen, toilet, shower, fridge. Sleep 2-6 persons." />
        <meta property="og:image" content="https://images.unsplash.com/photo-1523987355523-c7b5b0dd90a7?auto=format&fit=crop&w=1200" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://kigalicarrental.site/camping-car-rental-rwanda" />
        <meta property="twitter:title" content="Camping Car Rental Rwanda | Self-Contained Campervans & Motorhomes" />
        <meta property="twitter:description" content="Self-contained campervans and motorhomes for safari adventures. Complete kitchen, toilet, shower, fridge." />
        <meta property="twitter:image" content="https://images.unsplash.com/photo-1523987355523-c7b5b0dd90a7?auto=format&fit=crop&w=1200" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://kigalicarrental.site/camping-car-rental-rwanda" />
        ...
        <meta name="author" content="Kigali Car Rental - Camping Car Specialists" />
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
            <div className="max-w-4xl">
              ...
              <div className="flex items-center gap-2 text-sm text-[#D0D98D] mb-6">
                ...
                <span>›</span>
                <Link href="/camping" className="hover:text-white transition-colors">Camping</Link>
                <span>›</span>
                <span className="text-white">Camping Car Rental Rwanda</span>
              </div>
              
              <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                <span className="text-[#D0D98D]">Camping Car</span> Rental Rwanda
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
                <span className="text-[#D0D98D] font-semibold">Self-contained campervans and motorhomes</span> for 
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  Camper Hotline: +250 796 077 321
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Camping Car <span className="text-[#4B5320]">Packages</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320] p-8 hover:shadow-2xl transition-all group relative overflow-hidden">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$295</span>
                <span className="text-gray-500">/day</span>
              </div>
              <ul className="space-y-3 mb-8 text-gray-600">
                <li className="flex items-center gap-2">
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320]/20 p-8 hover:border-[#4B5320] hover:shadow-xl transition-all group">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$345</span>
                <span className="text-gray-500">/day</span>
              </div>
              <ul className="space-y-3 mb-8 text-gray-600">
                <li className="flex items-center gap-2">
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-600">
                  <span className="font-bold text-[#4B5320] text-lg">{filteredVehicles.length}</span> camping cars available
                </span>
                <button
                  onClick={() => {
                    setSelectedType('all');
              ...
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                    Camping Car <span className="text-[#4B5320]">Fleet</span>
                  </h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Why Choose a <span className="text-[#D0D98D]">Camping Car</span> in Rwanda
              </h2>
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Camping Car Rental Rwanda - <span className="text-[#4B5320]">FAQ</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Popular <span className="text-[#4B5320]">Campsites</span> in Rwanda
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                What Our <span className="text-[#4B5320]">Camping Car Guests Say</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                145+ 5-star reviews from camping adventures
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                ...
                <p className="text-gray-700 mb-4">"Our family of 4 spent 10 days in the motorhome. Akagera, Lake Kivu, and Volcanoes. Having our own toilet and shower made camping with kids so easy. Solar panels kept everything charged. Unforgettable!"</p>
                <div className="font-bold text-gray-900">The Wilson Family</div>
                <div className="text-sm text-gray-500">Motorhome • 10 days</div>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center gap-1 text-yellow-400 mb-3">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>
                ...
                <p className="text-gray-700 mb-4">"Rented a campervan for 2 weeks to explore Rwanda and Uganda. Crossed borders easily with the team's help. Vehicle was comfortable, well-equipped, and we saved a fortune on hotels. Best decision ever!"</p>
                <div className="font-bold text-gray-900">Overland Couple</div>
                <div className="text-sm text-gray-500">Campervan • Cross-border</div>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center gap-1 text-yellow-400 mb-3">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>
                ...
                <p className="text-gray-700 mb-4">"Stayed 5 nights at Lake Kivu in the motorhome. Waking up to the lake view, having breakfast outside, then driving to the next beach. Pure freedom. The vehicle was spotless and everything worked perfectly."</p>
                <div className="font-bold text-gray-900">Solo Adventurer</div>
                <div className="text-sm text-gray-500">Motorhome • Lake Kivu</div>
              </div>
            </div>
          </div>
        </div>
