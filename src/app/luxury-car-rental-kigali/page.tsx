// app/luxury-car-rental-kigali/page.tsx
"use client";
...
export default function LuxuryCarRentalKigali() {
  ...
  return (
    <>
      <Head>
        <title>Luxury Car Rental Kigali | Premium & Exotic Cars Rwanda | Mercedes, BMW, Range Rover</title>
        <meta name="description" content="Experience ultimate luxury with our premium car rental in Kigali. Mercedes-Benz S-Class, BMW 7 Series, Range Rover, Porsche, Lexus. VIP chauffeur service, airport pickup, 24/7 concierge. Book your luxury vehicle today." />
        <meta name="keywords" content="luxury car rental Kigali, premium car hire Rwanda, exotic cars Kigali, Mercedes rental Kigali, BMW rental Rwanda, Range Rover hire Kigali, Porsche rental, Lexus Kigali, chauffeur service, VIP transport Rwanda, luxury SUV rental, executive car hire, wedding car rental Kigali, airport luxury transfer" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://kigalicarrental.site/luxury-car-rental-kigali" />
        <meta property="og:title" content="Luxury Car Rental Kigali | Premium & Exotic Cars Rwanda" />
        <meta property="og:description" content="Experience the pinnacle of luxury with our premium fleet. Mercedes-Benz, BMW, Range Rover, Porsche. VIP chauffeur service available." />
        <meta property="og:image" content="https://images.unsplash.com/photo-1555215691-9ba3fb4f3e5b?auto=format&fit=crop&w=1200" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://kigalicarrental.site/luxury-car-rental-kigali" />
        <meta property="twitter:title" content="Luxury Car Rental Kigali | Premium & Exotic Cars Rwanda" />
        <meta property="twitter:description" content="Experience the pinnacle of luxury with our premium fleet. Mercedes-Benz, BMW, Range Rover, Porsche. VIP chauffeur service available." />
        <meta property="twitter:image" content="https://images.unsplash.com/photo-1555215691-9ba3fb4f3e5b?auto=format&fit=crop&w=1200" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://kigalicarrental.site/luxury-car-rental-kigali" />
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative bg-gradient-to-r from-gray-900 via-[#1a1a1a] to-gray-900 text-white overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                <span className="bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text text-transparent">Luxury</span> Car Rental Kigali
              </h1>
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed max-w-3xl">
                ...
                <span className="text-yellow-400 font-semibold"> Mercedes-Benz • BMW • Range Rover • Porsche • Lexus</span>
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <div className="text-2xl font-bold text-yellow-400">VIP</div>
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="#fleet"
                  className="px-8 py-4 bg-gradient-to-r from-yellow-500 to-yellow-600 text-gray-900 font-bold rounded-lg hover:from-yellow-600 hover:to-yellow-700 transition-all shadow-lg hover:shadow-xl"
                >
                  View Luxury Fleet
                </Link>
                <a
          ...
          {/* DECORATIVE ELEMENTS */}
          <div className="absolute bottom-0 right-0 w-1/3 h-full bg-gradient-to-l from-yellow-500/10 to-transparent"></div>
        </div>
        ...
        <div className="bg-white border-b border-gray-200 py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
              <span className="text-xl md:text-2xl font-bold text-gray-800 hover:text-yellow-600 transition-colors cursor-default">MERCEDES-BENZ</span>
              <span className="text-xl md:text-2xl font-bold text-gray-800 hover:text-yellow-600 transition-colors cursor-default">BMW</span>
              <span className="text-xl md:text-2xl font-bold text-gray-800 hover:text-yellow-600 transition-colors cursor-default">RANGE ROVER</span>
              <span className="text-xl md:text-2xl font-bold text-gray-800 hover:text-yellow-600 transition-colors cursor-default">PORSCHE</span>
              <span className="text-xl md:text-2xl font-bold text-gray-800 hover:text-yellow-600 transition-colors cursor-default">LEXUS</span>
              <span className="text-xl md:text-2xl font-bold text-gray-800 hover:text-yellow-600 transition-colors cursor-default">AUDI</span>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent bg-white"
                >
              ...
              <div className="bg-gray-50 rounded-lg p-4 text-center">
                <div className="text-3xl font-bold text-yellow-600">{filteredVehicles.length}</div>
                ...
                <button
                  ...
                  className="text-xs text-[#4B5320] hover:text-[#3A4218] mt-2 inline-block"
                >
                  Reset Filters
                </button>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-16 text-center border border-gray-200">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  ...
                  className="px-6 py-3 bg-yellow-500 text-gray-900 font-semibold rounded-lg hover:bg-yellow-600 transition-colors"
                >
            ...
            <>
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                  The <span className="text-yellow-600">Luxury Collection</span>
                </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredVehicles.map((vehicle) => (
                  <div
                    key={vehicle.id}
                    className="group bg-white rounded-2xl overflow-hidden border border-gray-200 hover:border-yellow-400 hover:shadow-2xl transition-all duration-500"
                  >
                    {/* IMAGE SECTION */}
                    <div className="relative h-64 overflow-hidden">
                      ...
                      {/* VIP BADGE */}
                      {vehicle.vipPackage && (
                        <div className="absolute top-4 right-4 bg-gradient-to-r from-yellow-500 to-yellow-600 text-gray-900 px-4 py-2 rounded-full text-sm font-bold flex items-center gap-1 shadow-lg">
                    ...
                    <div className="p-6">
                      ...
                      <div className="border-t border-gray-200 pt-4 mb-4">
                        <div className="flex items-baseline justify-between">
                          <div>
                            <span className="text-3xl font-bold text-yellow-600">{formatCurrency(vehicle.dailyRate)}</span>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <Link
                          ...
                          className="px-4 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 text-gray-900 text-sm font-bold rounded-lg hover:from-yellow-600 hover:to-yellow-700 transition-all text-center"
                        >
                          Reserve Now
                        </Link>
                        <Link
        ...
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-20 mt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-block px-4 py-2 bg-yellow-500/20 text-yellow-400 rounded-full text-sm font-bold mb-6 border border-yellow-500/30">
                  👑 VIP CHAUFFEUR SERVICE
                </div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  Arrive in <span className="text-yellow-400">Style & Elegance</span>
                </h2>
                ...
                <Link
                  ...
                  className="inline-flex items-center px-6 py-3 bg-yellow-500 text-gray-900 font-bold rounded-lg hover:bg-yellow-400 transition-colors"
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className="bg-white rounded-lg p-4 text-center hover:shadow-md transition-shadow">
                <div className="font-bold text-[#4B5320]">Kigali City</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-gradient-to-r from-[#4B5320] to-[#3A4218] rounded-3xl p-12 text-center text-white shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="tel:+250796077321"
                className="px-8 py-4 bg-yellow-500 text-gray-900 font-bold rounded-lg hover:bg-yellow-400 transition-colors text-lg"
              >
                VIP Hotline: +250 796 077 321
              </a>
              <Link
                href="/contact"
