// app/chauffeur-service-rwanda/page.tsx
"use client";
...
export default function ChauffeurServiceRwanda() {
  ...
  return (
    <>
      <Head>
        <title>Chauffeur Service Rwanda | Professional Driver Hire Kigali | Airport & Corporate Transfers</title>
        <meta name="description" content="✅ Premium chauffeur service Rwanda - Professional English-speaking drivers for airport transfers, corporate travel, weddings, city tours & safaris. Uniformed chauffeurs, flight tracking, meet & greet. Book online 24/7." />
        <meta name="keywords" content="chauffeur service Rwanda, professional driver Kigali, private chauffeur Rwanda, executive driver Kigali, airport transfer with chauffeur, corporate chauffeur Rwanda, wedding car with driver, luxury chauffeur service, VIP transport Kigali, chauffeur driven cars Rwanda, personal driver Rwanda, chauffeur hire Kigali, driver for business trip, meet and greet Kigali airport, flight tracking chauffeur, uniformed driver Rwanda, English speaking chauffeur, French speaking driver Kigali, chauffeur for safari, city tour with driver Kigali, executive transport Rwanda, chauffeur service rates Kigali, best chauffeur Rwanda" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://kigalicarrental.site/chauffeur-service-rwanda" />
        <meta property="og:title" content="Chauffeur Service Rwanda | Professional Driver Hire Kigali" />
        <meta property="og:description" content="Premium chauffeur service Rwanda - Professional English-speaking drivers for airport transfers, corporate travel, weddings, city tours & safaris." />
        <meta property="og:image" content="https://images.unsplash.com/photo-1557174361-f9d9a1f6c5b1?auto=format&fit=crop&w=1200" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://kigalicarrental.site/chauffeur-service-rwanda" />
        <meta property="twitter:title" content="Chauffeur Service Rwanda | Professional Driver Hire Kigali" />
        <meta property="twitter:description" content="Premium chauffeur service Rwanda - Professional English-speaking drivers for airport transfers, corporate travel, weddings, city tours & safaris." />
        <meta property="twitter:image" content="https://images.unsplash.com/photo-1557174361-f9d9a1f6c5b1?auto=format&fit=crop&w=1200" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://kigalicarrental.site/chauffeur-service-rwanda" />
        ...
        <meta name="author" content="Kigali Car Rental - Chauffeur Service Rwanda" />
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                <span className="text-[#D0D98D]">Chauffeur</span> Service Rwanda
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
                Professional <span className="text-[#D0D98D] font-semibold">English & French speaking chauffeurs</span>. 
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  Chauffeur Hotline: +250 796 077 321
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Chauffeur <span className="text-[#4B5320]">Service Packages</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320]/20 p-8 hover:border-[#4B5320] hover:shadow-xl transition-all group">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$45</span>
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-600">
                  <span className="font-bold text-[#4B5320] text-lg">{filteredVehicles.length}</span> chauffeur vehicles available
                </span>
                <button
                  onClick={() => {
              ...
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                    Professional <span className="text-[#4B5320]">Chauffeur Fleet</span>
                  </h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Why Choose Our <span className="text-[#D0D98D]">Chauffeur Service</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Chauffeur Service Rwanda - <span className="text-[#4B5320]">FAQ</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200 hover:border-[#4B5320] transition-all">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                You can book online through our website, call our 24/7 chauffeur dispatch at +250 796 077 321, or send a WhatsApp message. For same-day bookings, please call for immediate availability.
              </p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200 hover:border-[#4B5320] transition-all">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200 hover:border-[#4B5320] transition-all">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Absolutely! We offer multi-day chauffeur packages for business trips, conferences, and tours. Multi-day bookings include driver accommodation and discounted daily rates. Contact us for custom quotes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white rounded-lg p-4 text-center hover:border-[#4B5320] hover:shadow-md transition-all border border-transparent">
                <div className="font-bold text-[#4B5320]">Musanze</div>
                <div className="text-xs text-gray-500">Volcanoes National Park</div>
              </div>
              <div className="bg-white rounded-lg p-4 text-center hover:border-[#4B5320] hover:shadow-md transition-all border border-transparent">
                <div className="font-bold text-[#4B5320]">Akagera</div>
