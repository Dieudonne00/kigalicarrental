...
export const metadata: Metadata = {
  title: "Nyungwe Forest Car Hire | Kigali to Nyungwe Transfer - Kigali Car Hire",
  ...
  keywords: "nyungwe forest car hire, nyungwe national park car hire, kigali to nyungwe car hire, nyungwe chimpanzee trekking car hire, car hire nyungwe forest rwanda, nyungwe canopy walk transfer",
  alternates: { canonical: "https://kigalicarhire.rw/nyungwe-forest-car-hire" },
  openGraph: {
    title: "Nyungwe Forest Car Hire | Kigali Car Hire",
    description: "Car hire from Kigali to Nyungwe Forest. Chimpanzee trekking transfers and self-drive 4x4 from $70/day.",
    url: "https://kigalicarhire.rw/nyungwe-forest-car-hire",
  },
};
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "Yes. Many visitors combine Nyungwe Forest with Lake Kivu since Cyangugu on the lake is only about 50 km from the park. Kigali Car Hire offers multi-destination packages that combine Nyungwe, Lake Kivu, and other Rwanda destinations in a single hire." },
    },
  ],
};
...
export default function NyungweForestCarHirePage() {
  return (
    ...
    <div className="min-h-screen bg-gray-50">
      <section className="bg-gradient-to-br from-emerald-900 to-green-700 text-white py-20 md:py-32">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/250788892976" target="_blank" rel="noopener noreferrer" className="bg-emerald-700 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-emerald-600 transition-all border border-white/30">WhatsApp Us</a>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-16">
          <div>
            ...
            <p className="text-gray-600 mb-4">Kigali Car Hire provides 4x4 vehicles ideal for the Nyungwe journey. The roads are generally paved but steep mountain terrain means a 4x4 with good ground clearance is always the recommended choice, especially for visitors arriving in Rwanda's two rainy seasons.</p>
              ...
              {[
                ...
                <div key={item.pkg} className="border-b border-gray-100 pb-3">
                  <div className="flex justify-between items-start">
                    ...
                    <span className="font-bold text-[#01B000] text-sm ml-4">{item.price}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="bg-emerald-800 rounded-2xl p-10 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/250788892976" target="_blank" rel="noopener noreferrer" className="border-2 border-white text-white px-8 py-4 rounded-lg font-bold hover:bg-white hover:text-emerald-800 transition-all">WhatsApp Us</a>
          </div>
        </div>
      </div>
