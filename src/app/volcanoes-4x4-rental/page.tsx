// app/volcanoes-4x4-rental/page.tsx
"use client";
...
export default function Volcanoes4x4Rental() {
  ...
  return (
    <>
      <Head>
        <title>Volcanoes 4x4 Rental | Gorilla Trekking Vehicles for Volcanoes National Park | Toyota Land Cruiser & Prado</title>
        <meta name="description" content="✅ Volcanoes 4x4 rental - Specialized vehicles for gorilla trekking in Volcanoes National Park. Toyota Land Cruiser, Prado, Land Rover with high clearance, low-range gearing. Perfect for steep slopes, muddy roads, mountain terrain. Book your gorilla trekking transport today." />
        <meta name="keywords" content="volcanoes 4x4 rental, volcanoes national park vehicle hire, gorilla trekking transport, volcanoes national park 4x4, gorilla trekking vehicle, volcanoes park car rental, musanze 4x4 hire, toyota land cruiser volcanoes, toyota prado volcanoes, land rover volcanoes, mountain terrain 4x4, steep slope capable vehicle, muddy road 4x4, high clearance vehicle, low-range gearing 4x4, diff lock 4x4, gorilla trekking car, volcanoes national park guide, kinigi vehicle hire, bisoke trekking transport, karisimbi 4x4, sabyinyo vehicle, golden monkey trekking car, volcanoes national park entry, gorilla permit transport, rwanda gorilla trekking vehicle, best 4x4 for volcanoes" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://kigalicarrental.site/volcanoes-4x4-rental" />
        <meta property="og:title" content="Volcanoes 4x4 Rental | Gorilla Trekking Vehicles for Volcanoes National Park" />
        <meta property="og:description" content="Specialized 4x4 vehicles for gorilla trekking in Volcanoes National Park. Toyota Land Cruiser, Prado with high clearance, low-range gearing." />
        ...
        <meta property="twitter:url" content="https://kigalicarrental.site/volcanoes-4x4-rental" />
        <meta property="twitter:title" content="Volcanoes 4x4 Rental | Gorilla Trekking Vehicles" />
        <meta property="twitter:description" content="Specialized 4x4 vehicles for gorilla trekking in Volcanoes National Park." />
        <meta property="twitter:image" content="https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?auto=format&fit=crop&w=1200" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://kigalicarrental.site/volcanoes-4x4-rental" />
        ...
        <meta name="author" content="Kigali Car Rental - Volcanoes 4x4 Specialists" />
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                <span className="text-[#D0D98D]">Volcanoes 4x4</span> Rental
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
                <span className="text-[#D0D98D] font-semibold">Specialized 4x4 vehicles</span> for gorilla trekking 
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                ...
                <div className="bg-[#4B5320]/40 backdrop-blur-sm rounded-xl p-4 border border-[#D0D98D]/30">
                  <div className="text-2xl font-bold text-[#D0D98D]">4,500m</div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  Trekking Hotline: +250 796 077 321
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Gorilla Trekking <span className="text-[#4B5320]">Packages</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320]/20 p-8 hover:border-[#4B5320] hover:shadow-xl transition-all group">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$120</span>
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320] p-8 hover:shadow-2xl transition-all group relative overflow-hidden">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$185</span>
                <span className="text-gray-500">/day</span>
              </div>
              <ul className="space-y-3 mb-8 text-gray-600">
                <li className="flex items-center gap-2">
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-600">
                  <span className="font-bold text-[#4B5320] text-lg">{filteredVehicles.length}</span> 4x4 vehicles available for Volcanoes
                </span>
                <button
                  onClick={() => {
              ...
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                    Volcanoes <span className="text-[#4B5320]">4x4 Fleet</span>
                  </h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  About <span className="text-[#D0D98D]">Volcanoes National Park</span>
                </h2>
                <div className="space-y-4 text-gray-200">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-6">
                    <div>
                      <div className="text-2xl font-bold text-[#D0D98D]">160 km²</div>
                      <div className="text-sm">Park Size</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-[#D0D98D]">4,507m</div>
                      <div className="text-sm">Mt. Karisimbi</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-[#D0D98D]">12+</div>
                      <div className="text-sm">Gorilla Families</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-[#D0D98D]">$1,500</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Trekking <span className="text-[#4B5320]">Start Points</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {trekkingStartPoints.map((point, index) => (
              <div key={index} className="bg-white rounded-xl p-6 text-center shadow-md hover:shadow-lg transition-all border border-gray-200">
                ...
                <div className="text-sm text-[#4B5320] font-semibold mt-1">{point.elevation}</div>
                {point.popular && (
                  <div className="mt-2 text-xs bg-[#D0D98D] text-[#4B5320] px-2 py-1 rounded-full inline-block">
                    Most Popular
                  </div>
                )}
              </div>
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Volcanoes 4x4 Rental - <span className="text-[#4B5320]">FAQ</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200 hover:border-[#4B5320] transition-all">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Yes, absolutely. The roads to trekking start points are steep, muddy, and rocky. A high-clearance 4x4 with low-range gearing is essential, especially during wet season. We recommend Toyota Land Cruiser or Prado.
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200 hover:border-[#4B5320] transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              What Our <span className="text-[#4B5320]">Gorilla Trekking Guests Say</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
