    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-[400px] md:min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-16 md:py-32">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center px-6 md:px-8 py-3 md:py-4 bg-[#2563EB] text-white font-bold text-sm md:text-base rounded-lg hover:bg-[#1D4ED8] transition-all shadow-lg hover:shadow-xl"
          >
            <svg
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 mb-8 md:mb-16">
          <div className="bg-white rounded-xl border-2 border-gray-200 p-6 md:p-8">
            <div className="w-12 h-12 md:w-16 md:h-16 bg-blue-50 rounded-xl flex items-center justify-center text-[#2563EB] mb-4 md:mb-6">
              <svg
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 text-[#2563EB] mr-2 mt-0.5 flex-shrink-0"
                  fill="none"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  strokeWidth="2"
          ...
          <div className="bg-white rounded-xl border-2 border-gray-200 p-8">
            <div className="w-16 h-16 bg-blue-50 rounded-xl flex items-center justify-center text-[#2563EB] mb-6">
              <svg
                className="w-10 h-10"
                fill="none"
                strokeLinecap="round"
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
              {cars.map((car) => (
                <div
                  key={car.id}
                  className="bg-white rounded-xl border-2 border-gray-200 overflow-hidden hover:border-[#2563EB] transition-all duration-300 hover:shadow-lg"
                >
                  <div className="relative h-32 md:h-48">
                    ...
                    <div className="absolute top-2 md:top-4 right-2 md:right-4">
                      <span className="bg-[#2563EB] text-white px-2 md:px-3 py-0.5 md:py-1 rounded-full text-[10px] md:text-sm font-bold">
                        Game Drive
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-4 md:p-6">
                    ...
                    <div className="border-t pt-4">
                      ...
                      <Link
                        href={`/cars/${car.id}`}
                        className="block w-full text-center bg-[#2563EB] text-white py-3 rounded-lg font-bold hover:bg-[#1D4ED8] transition-all"
                      >
                        Book Now
                      </Link>
                    </div>
        ...
        <div className="bg-white rounded-xl border-2 border-gray-200 p-8 md:p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center px-6 py-3 bg-[#2563EB] text-white font-bold rounded-lg hover:bg-[#1D4ED8] transition-all"
            >
              <svg
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-6 py-3 border-2 border-gray-200 text-gray-900 font-bold rounded-lg hover:border-[#2563EB] hover:bg-[#2563EB] hover:text-white transition-all"
            >
              Contact Us
            </Link>
          </div>
