// app/car-hire-rwanda/CarHireRwandaClient.tsx
"use client";
  ...
  return (
    <main className="pt-24 pb-16 bg-gray-50 min-h-screen">
                  ...
                  <div className="p-6">
                    ...
                    <div className="border-t border-gray-200 pt-4 mb-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="text-2xl font-bold text-[#1D4ED8]">${car.dailyRate}</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-gradient-to-r from-[#1D4ED8] to-blue-800 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="bg-white text-[#1D4ED8] px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition-colors"
            >
              Contact Our Team
            </Link>
            <a
