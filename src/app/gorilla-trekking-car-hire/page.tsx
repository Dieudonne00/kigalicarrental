...
export const metadata: Metadata = {
  title: "Gorilla Trekking Car Hire Rwanda | 4x4 Car Hire Volcanoes National Park - Kigali Car Rental",
  description: "Hire a 4x4 car for gorilla trekking in Rwanda from $80 per day. Self-drive or chauffeur to Volcanoes National Park from Kigali. Book now - +250 787 619 387.",
  keywords: "Kigali car rental",
  alternates: { canonical: "https://kigalicarrental.site/gorilla-trekking-car-hire" },
  openGraph: {
    title: "Gorilla Trekking Car Hire Rwanda | Kigali Car Rental",
    description: "4x4 car hire for gorilla trekking in Rwanda. Self-drive or chauffeured to Volcanoes National Park from $80/day.",
    url: "https://kigalicarrental.site/gorilla-trekking-car-hire",
  },
};
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "Yes. Kigali Car Rental offers chauffeured transfers to Volcanoes National Park for gorilla trekking. Your driver will pick you up from your hotel in Kigali, wait at the park while you trek, and drive you back. This is the most comfortable and stress-free option." },
    },
    {
      "@type": "Question",
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-[#1e3a8a]/70 text-white py-20 md:py-32">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/book-now" className="bg-white text-blue-800 px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition-all">Book a 4x4 Now</Link>
              <a href="https://wa.me/250787619387" target="_blank" rel="noopener noreferrer" className="bg-[#1e3a8a] text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-[#172554] transition-all">WhatsApp Us</a>
            </div>
          </div>
        </section>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="grid md:grid-cols-2 gap-10 mb-16 items-start">
            <div>
              ...
              <p className="text-gray-600 mb-4">Kigali Car Rental provides 4x4 vehicles specifically chosen for the Kigali to Volcanoes National Park route. Our cars are well maintained, fully insured, and equipped with everything you need for a comfortable drive through Rwanda's beautiful landscape.</p>
              ...
              <Link href="/fleet" className="inline-block bg-[#1e3a8a] text-white px-6 py-3 rounded-lg font-bold hover:bg-[#172554] transition-all">View 4x4 Fleet</Link>
            </div>
                ...
                {[
                  ...
                  <div key={pkg.name} className="border-b border-gray-100 pb-4">
                    <div className="flex justify-between items-start">
                      ...
                      <span className="font-bold text-[#1e3a8a] text-sm whitespace-nowrap ml-4">{pkg.price}</span>
                    </div>
                  </div>
                ))}
              </div>
