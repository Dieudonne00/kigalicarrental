        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border-2 border-gray-200 p-6 md:p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
              <svg className="w-6 h-6 text-[#2563EB]" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-[#2563EB] focus:outline-none text-gray-900"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-[#2563EB] focus:outline-none text-gray-900 resize-none"
                ></textarea>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              type="submit"
              className="flex-1 bg-[#2563EB] text-white px-8 py-4 rounded-lg font-bold hover:bg-[#1D4ED8] transition-all shadow-lg hover:shadow-xl"
            >
            ...
            <button
              ...
              className="flex-1 bg-white border-2 border-gray-200 text-gray-700 px-8 py-4 rounded-lg font-bold hover:border-[#2563EB] hover:text-[#2563EB] transition-all"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-[#2563EB]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-[#2563EB]" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
