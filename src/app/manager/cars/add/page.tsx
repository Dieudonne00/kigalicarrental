...
export default function AddCarPage() {
  ...
  // One unified, unlimited, all-optional photo list - the first entry is
  // what every listing/card shows as the car's photo, "Set as main" just
  // reorders the array rather than needing a separate required "thumbnail"
  // upload. Each photo tracks its own upload state so multiple files
  // selected together upload independently.
      ...
      <div className="flex-1 overflow-y-auto lg:ml-64 p-8">
        ...
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
          ...
          <div className="flex gap-4 mt-6">
            ...
            <button
              type="submit"
              disabled={loading || uploadingAnyPhoto}
            ...
            >
              {loading ? "Saving..." : uploadingAnyPhoto ? "Uploading photos..." : "Add Car"}
            </button>
          </div>
        </form>
      </div>
