...
export default function AkageraSafariRental() {
  ...
  return (
    <>
      <Head>
        <title>Akagera Safari Rental | 4x4 Vehicles for Akagera National Park Game Drives | Big Five Safari Rwanda</title>
        <meta name="description" content="✅ Akagera safari rental - Rent 4x4 safari vehicles for Akagera National Park. Toyota Land Cruiser with pop-up roof, game viewing seats. Self-drive or guided safaris. Big Five game viewing. Book your Akagera adventure today." />
        <meta name="keywords" content="akagera safari rental, akagera national park vehicle hire, akagera game drive vehicle, akagera 4x4 rental, akagera safari car, akagera self-drive safari, akagera guided safari, akagera pop-up roof vehicle, akagera camping safari, akagera overnight safari, akagera big five safari, akagera lion viewing, akagera elephant safari, akagera rhino tracking, akagera boat safari vehicle, akagera bird watching car, akagera safari with guide, toyota land cruiser akagera, land rover akagera, 4x4 for akagera national park, akagera game drive rental, akagera safari prices, akagera national park entry, best vehicle for akagera, akagera wet season vehicle, akagera dry season safari" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://kigalicarrental.site/akagera-safari-rental" />
        <meta property="og:title" content="Akagera Safari Rental | 4x4 Vehicles for Akagera National Park Game Drives" />
        <meta property="og:description" content="Rent 4x4 safari vehicles for Akagera National Park. Toyota Land Cruiser with pop-up roof, game viewing seats. Big Five game viewing." />
        <meta property="og:image" content="https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=1200" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://kigalicarrental.site/akagera-safari-rental" />
        <meta property="twitter:title" content="Akagera Safari Rental | 4x4 Vehicles for Akagera National Park" />
        <meta property="twitter:description" content="Rent 4x4 safari vehicles for Akagera National Park. Toyota Land Cruiser with pop-up roof, game viewing seats." />
        <meta property="twitter:image" content="https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=1200" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://kigalicarrental.site/akagera-safari-rental" />
        ...
        <meta name="author" content="Kigali Car Rental - Akagera Safari Specialists" />
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                <span className="text-[#D0D98D]">Akagera Safari</span> Rental
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
                <span className="text-[#D0D98D] font-semibold">4x4 safari vehicles</span> for Akagera National Park. 
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                ...
                <div className="bg-[#4B5320]/40 backdrop-blur-sm rounded-xl p-4 border border-[#D0D98D]/30">
                  <div className="text-2xl font-bold text-[#D0D98D]">1,122</div>
                  <div className="text-xs text-gray-300 mt-1">km² Park Size</div>
                </div>
                <div className="bg-[#4B5320]/40 backdrop-blur-sm rounded-xl p-4 border border-[#D0D98D]/30">
                  <div className="text-2xl font-bold text-[#D0D98D]">Big Five</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Akagera <span className="text-[#4B5320]">Safari Packages</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320]/20 p-8 hover:border-[#4B5320] hover:shadow-xl transition-all group">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$285</span>
                <span className="text-gray-500">/vehicle</span>
              </div>
              <ul className="space-y-3 mb-8 text-gray-600">
                <li className="flex items-center gap-2">
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-600">
                  <span className="font-bold text-[#4B5320] text-lg">{filteredVehicles.length}</span> Akagera safari vehicles available
                </span>
                <button
                  onClick={() => {
              ...
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                    Akagera <span className="text-[#4B5320]">Safari Fleet</span>
                  </h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  About <span className="text-[#D0D98D]">Akagera National Park</span>
                </h2>
                <div className="space-y-4 text-gray-200">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-6">
                    <div>
                      <div className="text-2xl font-bold text-[#D0D98D]">{akageraInfo.size}</div>
                      <div className="text-sm">Park Size</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-[#D0D98D]">500+</div>
                      <div className="text-sm">Bird Species</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-[#D0D98D]">2.5 hrs</div>
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Akagera Safari - <span className="text-[#4B5320]">FAQ</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200 hover:border-[#4B5320] transition-all">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Yes, a 4x4 is recommended, especially during wet season (March-May, October-November). The game drive tracks can become muddy, and high clearance is needed. All our safari vehicles are genuine 4x4s.
                </p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200 hover:border-[#4B5320] transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Wildlife You'll See on <span className="text-[#4B5320]">Akagera Safari</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                What Our <span className="text-[#4B5320]">Akagera Guests Say</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                287+ 5-star reviews from Akagera safaris
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                ...
                <p className="text-gray-700 mb-4">"The Land Cruiser with pop-up roof was perfect for Akagera. We saw lions, elephants, and even rhinos. Standing through the roof for photos was amazing. Vehicle was clean and well-maintained."</p>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                ...
                <p className="text-gray-700 mb-4">"Our guided safari with Jean was incredible. He knew exactly where to find the lions and leopards. The vehicle had a pop-up roof and we got amazing photos. Best day of our Rwanda trip."</p>
                <div className="font-bold text-gray-900">Sarah & David</div>
                <div className="text-sm text-gray-500">Guided Safari • Akagera</div>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center gap-1 text-yellow-400 mb-3">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>
                ...
                <p className="text-gray-700 mb-4">"Spent 2 nights camping in Akagera with the roof tent equipped Land Cruiser. Woke up to hippos grazing nearby. The fridge kept our food cold, and we cooked dinner under the stars. Unforgettable!"</p>
                <div className="font-bold text-gray-900">Camping Adventure</div>
                <div className="text-sm text-gray-500">Overnight Safari • Akagera</div>
              </div>
            </div>
          </div>
        </div>
