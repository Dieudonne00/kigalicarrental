...
export default function EventTransportDriver() {
  ...
  return (
    <>
      <Head>
        <title>Event Transport Driver Kigali | Wedding Cars, Conference Shuttles & Special Occasion Transport Rwanda</title>
        <meta name="description" content="✅ Event transport driver Kigali - Professional drivers for weddings, conferences, corporate events, concerts & private parties. Luxury vehicles, formal attire, decoration allowed, champagne service, red carpet. Book your event transport today." />
        <meta name="keywords" content="event transport driver Kigali, wedding car with driver Rwanda, conference shuttle service Kigali, corporate event transport, concert transportation Rwanda, festival driver service, private party chauffeur, special occasion transport, wedding chauffeur Kigali, bridal car hire Rwanda, conference delegate transfer, event shuttle bus Kigali, VIP event transport, red carpet driver service, champagne service vehicle, decorated wedding car, graduation transport Kigali, anniversary chauffeur, birthday party driver, gala event transportation, awards ceremony chauffeur, product launch driver, exhibition shuttle service, trade show transport Rwanda, festival shuttle Kigali, concert pickup and drop off, event guest transfer, group transportation for events" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://kigalicarrental.site/event-transport-driver" />
        <meta property="og:title" content="Event Transport Driver Kigali | Wedding Cars, Conference Shuttles & Special Occasion Transport" />
        <meta property="og:description" content="Professional drivers for weddings, conferences, corporate events, concerts & private parties. Luxury vehicles, formal attire, decoration allowed." />
        <meta property="og:image" content="https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=1200" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://kigalicarrental.site/event-transport-driver" />
        <meta property="twitter:title" content="Event Transport Driver Kigali | Wedding Cars, Conference Shuttles & Special Occasion Transport" />
        <meta property="twitter:description" content="Professional drivers for weddings, conferences, corporate events, concerts & private parties. Luxury vehicles, formal attire, decoration allowed." />
        <meta property="twitter:image" content="https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=1200" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://kigalicarrental.site/event-transport-driver" />
        ...
        <meta name="author" content="Kigali Car Rental - Event Transport Driver" />
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
            <div className="max-w-4xl">
              ...
              <div className="flex items-center gap-2 text-sm text-[#D0D98D] mb-6">
                ...
                <span>›</span>
                <Link href="/event-services" className="hover:text-white transition-colors">Event Services</Link>
                <span>›</span>
                <span className="text-white">Event Transport Driver</span>
              </div>
              
              <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                <span className="text-[#D0D98D]">Event Transport</span> Driver Kigali
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
                Professional <span className="text-[#D0D98D] font-semibold">event transportation</span> for weddings, conferences, 
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                ...
                <div className="bg-[#4B5320]/40 backdrop-blur-sm rounded-xl p-4 border border-[#D0D98D]/30">
                  <div className="text-2xl font-bold text-[#D0D98D]">30+</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Event Transport <span className="text-[#4B5320]">Packages</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320]/20 p-8 hover:border-[#4B5320] hover:shadow-xl transition-all group">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$180</span>
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320] p-8 hover:shadow-2xl transition-all group relative overflow-hidden">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$320</span>
            ...
            <div className="bg-white rounded-2xl border-2 border-[#4B5320]/20 p-8 hover:border-[#4B5320] hover:shadow-xl transition-all group">
              ...
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-[#4B5320]">$140</span>
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-600">
                  <span className="font-bold text-[#4B5320] text-lg">{filteredVehicles.length}</span> event vehicles available
                </span>
                <button
                  onClick={() => {
              ...
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                    Event Transport <span className="text-[#4B5320]">Fleet</span>
                  </h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Why Choose Our <span className="text-[#D0D98D]">Event Transport Service</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Event Transport Driver - <span className="text-[#4B5320]">FAQ</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              What Our <span className="text-[#4B5320]">Event Clients Say</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
