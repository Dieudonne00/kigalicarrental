  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div>
          ...
          {[
            ...
            <div key={i} className="flex gap-4 mb-6">
              <div className="w-12 h-12 rounded-full bg-[rgba(75,83,32,0.1)] text-[#1D4ED8] flex items-center justify-center">
                ●
              </div>
              <div>
        ...
        <div className="bg-white border-2 border-gray-200 rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-[#1D4ED8] hover:bg-[#1E3A8A] text-white font-bold py-4 rounded-lg transition"
            >
      ...
      <section className="bg-gradient-to-r from-[#1D4ED8] to-[#1E3A8A] py-16 text-white text-center">
        ...
        <a
          href="/fleet"
          className="inline-block bg-white text-[#1D4ED8] px-8 py-4 rounded-lg font-bold"
        >
          Browse Our Fleet
        </a>
      </section>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center">
          <div className="bg-white rounded-xl p-8 max-w-md w-full text-center">
            <h3 className={`text-2xl font-bold mb-4 ${modalContent.type === "success" ? "text-[#1D4ED8]" : "text-red-600"}`}>
              {modalContent.type === "success" ? "Success" : "Error"}
            </h3>
            <p className="mb-6">{modalContent.message}</p>
            <button
              onClick={() => setShowModal(false)}
              className="w-full bg-[#1D4ED8] hover:bg-[#1E3A8A] text-white py-3 rounded-lg font-bold"
            >
              Close
            </button>
          </div>
