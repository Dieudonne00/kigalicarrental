...
export const metadata: Metadata = {
  title: "Airport Transfer Kigali | Car Hire Kigali International Airport - Kigali Car Rental",
  description: "Book a reliable airport transfer in Kigali from $30. We meet you at Kigali International Airport arrivals 24/7 with a name board. Fixed prices, no hidden fees. Call +250 787 619 387.",
  keywords: "Kigali car rental",
  alternates: { canonical: "https://kigalicarrental.site/airport-transfer-kigali" },
  openGraph: {
    title: "Airport Transfer Kigali | Kigali Car Rental",
    description: "Meet and greet at Kigali International Airport 24/7. Fixed rates from $30. Book online or WhatsApp +250 787 619 387.",
    url: "https://kigalicarrental.site/airport-transfer-kigali",
  },
};
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "Yes. Kigali Car Rental provides 24 hour airport pickup and drop off at Kigali International Airport. Our driver will meet you at arrivals with a name board regardless of your flight time." },
    },
    {
      "@type": "Question",
      name: "How do I book an airport transfer in Kigali?",
      acceptedAnswer: { "@type": "Answer", text: "You can book your Kigali airport transfer online via our booking form, by calling +250 787 619 387, or by sending a WhatsApp message. We recommend booking at least 24 hours in advance." },
    },
    {
      "@type": "Question",
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-[#1e3a8a]/80 text-white py-20 md:py-32">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <span className="inline-block bg-[#1e3a8a] text-white text-sm font-bold px-4 py-1 rounded-full mb-6">24/7 Available</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/book-now" className="bg-[#1e3a8a] text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-[#172554] transition-all">Book Airport Transfer</Link>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
            ...
            {[
              ...
              <div key={item.title} className="bg-white rounded-xl border-2 border-gray-200 p-6">
                <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-[#1e3a8a]" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M5 13l4 4L19 7" /></svg>
                </div>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                ...
                <div key={item.step} className="bg-white rounded-xl border-2 border-gray-200 p-6 text-center">
                  <div className="w-10 h-10 bg-[#1e3a8a] text-white rounded-full flex items-center justify-center font-bold text-lg mx-auto mb-3">{item.step}</div>
          ...
          <div className="bg-[#1e3a8a] rounded-2xl p-10 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/book-now" className="bg-white text-[#1e3a8a] px-8 py-4 rounded-lg font-bold hover:bg-gray-100 transition-all">Book Online</Link>
              <a href="tel:+250787619387" className="border-2 border-white text-white px-8 py-4 rounded-lg font-bold hover:bg-white hover:text-[#1e3a8a] transition-all">Call +250 787 619 387</a>
            </div>
          </div>
        </div>
      </div>
