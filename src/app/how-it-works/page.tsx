...
export default function HowItWorksPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Steps Section */}
      <section id="booking" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div
              key={index}
              className="bg-white rounded-xl border-2 border-gray-200 p-8 hover:border-[#1e3a8a] transition-all group"
            >
              {/* Step Number */}
              <div className="text-6xl font-bold text-gray-200 group-hover:text-[#1e3a8a]/20 transition-colors mb-4">
                {step.number}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {requirements.map((req, index) => (
              <div
                key={index}
                className="bg-gray-50 rounded-xl border-2 border-gray-200 p-6 text-center hover:border-[#1e3a8a] transition-all"
              >
                <div className="inline-flex items-center justify-center w-16 h-16 bg-[#1e3a8a]/10 rounded-full text-[#1e3a8a] mb-4">
                  {req.icon}
                </div>
            ...
            {[
              ...
              <div
                ...
                className={`bg-white rounded-xl border-2 transition-all ${
                  openFaq === index ? 'border-[#1e3a8a]' : 'border-gray-200'
                }`}
              >
                <button
                ...
                >
                  ...
                  <svg
                    className={`w-6 h-6 text-[#1e3a8a] flex-shrink-0 transition-transform ${
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={index + 6}
                className={`bg-white rounded-xl border-2 transition-all ${
                  openFaq === index + 6 ? 'border-[#1e3a8a]' : 'border-gray-200'
                }`}
              >
                <button
      ...
      <section className="bg-gradient-to-r from-[#1e3a8a] to-[#172554] text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-white rounded-lg font-bold hover:bg-white hover:text-[#1e3a8a] transition-all"
            >
              <svg
                className="w-5 h-5 mr-2"
                fill="none"
