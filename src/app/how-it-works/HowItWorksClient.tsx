    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-32">
          ...
          <a
            href="/fleet"
            className="inline-flex items-center justify-center px-8 py-4 bg-[#1D4ED8] text-white font-bold rounded-lg hover:bg-[#1e3a8a] transition-all"
          >
            <svg
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div
              key={index}
              className="bg-white rounded-xl border-2 border-gray-200 p-8 hover:border-[#1D4ED8] transition-all group"
            >
              {/* Step Number */}
              <div className="text-6xl font-bold text-gray-200 group-hover:text-[#1D4ED8]/20 transition-colors mb-4">
                {step.number}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {requirements.map((req, index) => (
              <div
                key={index}
                className="bg-gray-50 rounded-xl border-2 border-gray-200 p-6 text-center hover:border-[#1D4ED8] transition-all"
              >
                <div className="inline-flex items-center justify-center w-16 h-16 bg-[#1D4ED8]/10 rounded-full text-[#1D4ED8] mb-4">
                  {req.icon}
                </div>
            ...
            {[
              ...
              <div
                ...
                className={`bg-white rounded-xl border-2 transition-all ${
                  openFaq === index ? 'border-[#1D4ED8]' : 'border-gray-200'
                }`}
              >
                <button
                ...
                >
                  ...
                  <svg
                    className={`w-6 h-6 text-[#1D4ED8] flex-shrink-0 transition-transform ${
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={index + 6}
                className={`bg-white rounded-xl border-2 transition-all ${
                  openFaq === index + 6 ? 'border-[#1D4ED8]' : 'border-gray-200'
                }`}
              >
                <button
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-[#1D4ED8] to-[#1e3a8a] text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/fleet"
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-[#1D4ED8] rounded-lg font-bold hover:bg-gray-100 transition-all"
            >
              <svg
                className="w-5 h-5 mr-2"
                fill="none"
            ...
            <a
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-white rounded-lg font-bold hover:bg-white hover:text-[#1D4ED8] transition-all"
            >
              <svg
                className="w-5 h-5 mr-2"
                fill="none"
