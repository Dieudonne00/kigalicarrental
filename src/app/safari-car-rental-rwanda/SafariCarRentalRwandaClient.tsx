// app/safari-car-rental-rwanda/SafariCarRentalRwandaClient.tsx
"use client";
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
            <div className="max-w-4xl">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                <span className="text-[#93C5FD]">Safari Car Rental</span> Rwanda
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed max-w-3xl">
                Specialized <span className="text-[#93C5FD] font-semibold">game drive vehicles</span> for 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Rwanda's <span className="text-[#1D4ED8]">National Parks</span> for Safari
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {nationalParks.map((park, index) => (
              <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-200 hover:border-[#1D4ED8] hover:shadow-xl transition-all group">
                <div className="h-32 bg-gradient-to-r from-[#1D4ED8] to-[#1E40AF] flex items-center justify-center text-5xl">
                  {park.icon}
                </div>
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#1D4ED8] transition-colors">
                    {park.name}
                  </h3>
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Safari <span className="text-[#1D4ED8]">Experience Packages</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl border-2 border-[#1D4ED8]/20 p-8 hover:border-[#1D4ED8] hover:shadow-xl transition-all group">
                ...
                <div className="flex items-baseline gap-1 mb-6">
                  <span className="text-4xl font-bold text-[#1D4ED8]">$1,450</span>
              ...
              <div className="bg-white rounded-2xl border-2 border-[#1D4ED8] p-8 hover:shadow-2xl transition-all group relative overflow-hidden">
                ...
                <div className="flex items-baseline gap-1 mb-6">
                  <span className="text-4xl font-bold text-[#1D4ED8]">$890</span>
                  <span className="text-gray-500">/person</span>
                </div>
                <ul className="space-y-3 mb-8 text-gray-600">
                  <li className="flex items-center gap-2">
              ...
              <div className="bg-white rounded-2xl border-2 border-[#1D4ED8]/20 p-8 hover:border-[#1D4ED8] hover:shadow-xl transition-all group">
                ...
                <div className="flex items-baseline gap-1 mb-6">
                  <span className="text-4xl font-bold text-[#1D4ED8]">$950</span>
                  <span className="text-gray-500">/person</span>
                </div>
                <ul className="space-y-3 mb-8 text-gray-600">
                  <li className="flex items-center gap-2">
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-600">
                  <span className="font-bold text-[#1D4ED8] text-lg">{filteredVehicles.length}</span> safari vehicles available
                </span>
                <button
                  onClick={() => {
                    setSelectedPark('all');
              ...
              <div className="flex justify-between items-center mb-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                    Safari <span className="text-[#1D4ED8]">Vehicle Fleet</span>
                  </h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Why Choose Our <span className="text-[#93C5FD]">Safari Vehicles</span>
              </h2>
        ...
        {/* SAFARI VS CAMPING VEHICLE - UNIQUE CONTENT */}
        <div className="bg-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center">
              What "Safari-Ready" Actually Means — And When You Need It
            </h2>
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p>
                A safari vehicle rental is built around one job: getting you close to wildlife and letting you see and photograph it properly. That means a raised or pop-up roof so you can stand while the vehicle is stationary, elevated seating so sightlines aren't blocked by the row in front, and enough ground clearance to handle park tracks without scraping the underside. That's a different focus from our camping-equipped rentals — a safari vehicle isn't designed to be slept in overnight; it's designed to be the best possible platform for a game drive, and most people renting one are staying at a lodge or tented camp rather than camping out of the vehicle itself.
              </p>
              <p>
                Where this matters most is Akagera National Park, Rwanda's one true savanna-style Big Five park, where long game drives across open terrain reward a vehicle with a good vantage point and the range to cover the park's tracks in a day. In the forest parks — Nyungwe and Volcanoes — the calculus changes: "safari" there usually means tracking gorillas, golden monkeys, or chimpanzees on foot after a scenic drive to the trailhead, so the vehicle's job shifts from a viewing platform to reliable transport on steep, sometimes muddy park-access roads. A 4x4 with strong ground clearance still matters, but the pop-up roof and elevated seating see far less use than they do on an Akagera game drive.
              </p>
              <p>
                If your plan includes overnight stops away from lodges — parking at Akagera's public campsite, for instance, or camping between parks — you'll get more use out of a vehicle built for that: either our <Link href="/rooftop-tent-car-rental-rwanda" className="text-[#1D4ED8] font-semibold hover:underline">rooftop tent 4x4s</Link>, which keep full off-road ability while adding a tent on the roof rack, or our <Link href="/camping-car-rental-rwanda" className="text-[#1D4ED8] font-semibold hover:underline">self-contained camping cars</Link>, which add a built-in kitchen and sleeping cabin for longer, lodge-free road trips.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Safari Car Rental Rwanda - <span className="text-[#1D4ED8]">FAQ</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Wildlife You'll See on <span className="text-[#1D4ED8]">Rwanda Safari</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                What Our <span className="text-[#1D4ED8]">Safari Guests Say</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
