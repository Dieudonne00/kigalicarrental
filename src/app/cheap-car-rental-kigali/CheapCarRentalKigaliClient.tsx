// app/cheap-car-rental-kigali/CheapCarRentalKigaliClient.tsx
"use client";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          ...
          <Link
            href="#fleet"
            className="inline-flex items-center justify-center px-8 py-4 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl"
          >
            <svg
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" id="fleet">
            ...
            <div className="bg-white rounded-xl border-2 border-gray-200 p-6 sticky top-4">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-600 mb-2">
                    <span className="font-bold text-[#1D4ED8]">${priceRange[0]}</span>
                    <span className="text-gray-400">—</span>
                    <span className="font-bold text-[#1D4ED8]">${priceRange[1]}</span>
                  </div>
                  <div className="relative">
                    <input
                      ...
                      className="absolute w-full accent-[#1D4ED8] pointer-events-auto"
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs text-gray-600">
                      <span className="font-bold text-blue-700">Weekly rentals save 15%</span> - Book 7+ days for best value.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-sm text-gray-600">
                  <span className="text-2xl font-bold text-blue-600">{filteredCars.length}</span> budget vehicles available
                </p>
        ...
        {!loading && filteredCars.length === 0 && (
          <div className="text-center py-12 bg-white rounded-xl border-2 border-gray-200">
            ...
            <button
              onClick={resetFilters}
              className="px-6 py-2 bg-[#1D4ED8] text-white rounded-lg font-bold hover:bg-[#1e3a8a] transition-all"
            >
          ...
          <>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900">
                Budget Cars <span className="text-blue-600">${priceRange[0]} - ${priceRange[1]}</span>
              </h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
              {filteredCars.map((car) => (
                <Link
                  ...
                  className="group bg-white rounded-xl border-2 border-gray-200 overflow-hidden hover:border-blue-500 transition-all hover:shadow-lg"
                >
                  {/* Car Image */}
                  <div className="relative h-32 md:h-48 bg-gray-100 overflow-hidden">
                    ...
                    {/* BUDGET BADGE */}
                    <div className="absolute top-1 md:top-2 right-1 md:right-2 bg-blue-500 text-white px-1.5 md:px-3 py-0.5 md:py-1 rounded-full text-[9px] md:text-xs font-bold flex items-center gap-1">
                  ...
                  <div className="p-3 md:p-6">
                    <div className="flex justify-between items-start mb-1">
                      <h3 className="text-sm md:text-xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors line-clamp-1">
                        {car.name}
                      </h3>
                      <span className="bg-blue-100 text-blue-800 text-[8px] md:text-xs px-1.5 py-0.5 md:px-2 md:py-1 rounded-full font-bold">
                        ${car.dailyRate}
                      </span>
                    </div>
                    ...
                    <div className="flex items-baseline justify-between pt-2 md:pt-4 border-t border-gray-200">
                      <div>
                        <span className="text-base md:text-2xl font-bold text-blue-600">${car.dailyRate}</span>
                      ...
                      <div className="bg-blue-600 text-white p-1 md:p-2 rounded-full group-hover:bg-blue-700 transition-colors">
        ...
        {/* Budget Tips Section */}
        {!loading && filteredCars.length > 0 && (
          <div className="mt-16 bg-gradient-to-r from-blue-50 to-blue-50 rounded-xl border-2 border-blue-200 p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <div className="inline-block px-3 py-1 bg-blue-200 text-blue-800 rounded-full text-xs font-bold mb-4">
                  💰 PRO TIPS
                </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-blue-200">
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-600 mb-2">Need a better deal?</div>
                  <p className="text-gray-600 mb-4">Contact us for long-term discounts and special offers</p>
                  <div className="flex flex-col gap-3">
                    <a
                      href="tel:+250787619387"
                      className="inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white rounded-lg font-bold hover:bg-blue-700 transition-all"
                    >
                    ...
                    <Link
                      ...
                      className="inline-flex items-center justify-center px-6 py-3 border-2 border-blue-600 text-blue-600 rounded-lg font-bold hover:bg-blue-50 transition-all"
                    >
