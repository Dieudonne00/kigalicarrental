            ...
            <div className="bg-white rounded-xl border-2 border-gray-200 overflow-hidden mb-6">
              ...
              <div className="relative h-96 bg-gray-100">
                ...
                <div className="absolute top-4 right-4 flex gap-2">
                  ...
                  {car.featured && (
                    <span className="inline-block px-4 py-2 bg-[#1D4ED8] text-white rounded-full text-sm font-bold">
                      Featured
                    </span>
                  )}
                </div>
                ...
                <form onSubmit={handleBookingSubmit} className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 py-3 bg-[#1D4ED8] text-white rounded-lg font-bold hover:bg-[#1e40af] transition-all disabled:opacity-50"
                    >
