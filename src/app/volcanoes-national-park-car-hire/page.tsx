...
export const metadata: Metadata = {
  title: "Volcanoes National Park Car Hire | Kigali to Volcanoes Transfer - Kigali Car Rental",
  ...
  alternates: { canonical: "https://kigalicarrental.site/volcanoes-national-park-car-hire" },
  openGraph: {
    title: "Volcanoes National Park Car Hire | Kigali Car Rental",
    description: "Car hire from Kigali to Volcanoes National Park from $80/day. Gorilla trekking transfers available.",
    url: "https://kigalicarrental.site/volcanoes-national-park-car-hire",
  },
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: { "@type": "Answer", text: "Volcanoes National Park is 110 km from Kigali, about a 2.5 hour drive via the Kigali to Musanze road. Kigali Car Rental provides self-drive 4x4 hire and chauffeured transfers for the journey. We recommend departing Kigali by 5:30 AM to reach the park briefing at 7:00 AM." },
    },
    {
      "@type": "Question",
    ...
    <div className="min-h-screen bg-gray-50">
      <section className="bg-gradient-to-br from-blue-900 to-blue-700 text-white py-20 md:py-32">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <span className="inline-block bg-blue-500 text-white text-sm font-bold px-4 py-1 rounded-full mb-6">Gorilla Trekking Transfers</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/book-now" className="bg-white text-blue-800 px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition-all">Book Transfer</Link>
            <a href="https://wa.me/250787619387" target="_blank" rel="noopener noreferrer" className="bg-blue-600 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-blue-500 transition-all">WhatsApp Us</a>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-10 mb-16">
          <div>
            ...
            <p className="text-gray-600 mb-4">Kigali Car Rental provides reliable and affordable car hire for the Kigali to Volcanoes National Park journey. Choose from self-drive 4x4 hire, chauffeured day transfers, or multi-day hire packages that combine gorilla trekking with other Rwanda destinations.</p>
              ...
              {[
                ...
                <div key={opt.type} className="border-b border-gray-100 pb-4">
                  <div className="flex justify-between items-start">
                    ...
                    <span className="font-bold text-[#1e3a8a] text-sm ml-4">{opt.price}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="bg-blue-800 rounded-2xl p-10 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/book-now" className="bg-white text-blue-800 px-8 py-4 rounded-lg font-bold hover:bg-gray-100 transition-all">Book Now</Link>
