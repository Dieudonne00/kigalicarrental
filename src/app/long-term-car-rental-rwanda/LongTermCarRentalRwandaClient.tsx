  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-[550px] flex items-center justify-center overflow-hidden">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-blue-900/90 to-blue-900/90"></div>
        </div>

        {/* Content */}
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          <div className="inline-block px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full text-sm font-bold mb-6 shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="#fleet"
              className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-600 text-white font-bold rounded-lg hover:from-blue-700 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl"
            >
      ...
      <div className="bg-gradient-to-r from-blue-900 to-blue-900 py-4 sticky top-0 z-30 shadow-lg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" id="fleet">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative h-48 bg-gray-100 overflow-hidden">
                      ...
                      {/* LONG TERM BADGE */}
                      <div className="absolute top-3 right-3 bg-gradient-to-r from-blue-600 to-blue-600 text-white px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1 shadow-lg">
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex items-end justify-between">
                          <div>
                            ...
                            {car.dailyRate && (
                              <div className="text-xs text-gray-500 mt-1">
                                ...
                                <span className="text-blue-600 font-bold ml-2">Save {monthlySavings}%</span>
                              </div>
                            )}
                          </div>
                          {car.weeklyRate && weeklySavings > 0 && (
                            <div className="text-right">
                              ...
                              <div className="text-xs text-blue-600">Save {weeklySavings}%</div>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="flex gap-2 mt-3">
                          {rentalDuration === "quarterly" && (
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-2 flex-1">
                              <div className="text-xs text-blue-600 font-bold">3 Months</div>
                              <div className="text-sm font-bold">${formatPrice((car.monthlyRate || 0) * 3)}</div>
                              <div className="text-xs text-blue-600">Save 25%</div>
                            </div>
                          )}
                          {rentalDuration === "yearly" && (
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-2 flex-1">
                              <div className="text-xs text-blue-600 font-bold">12 Months</div>
                              <div className="text-sm font-bold">${formatPrice((car.monthlyRate || 0) * 12)}</div>
                              <div className="text-xs text-blue-600">Save 40%</div>
                            </div>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <Link
                          ...
                          className="flex items-center justify-center px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-600 text-white rounded-lg font-bold hover:from-blue-700 hover:to-blue-700 transition-all text-sm"
                        >
        ...
        {!loading && filteredCars.length > 0 && (
          <div className="mt-16">
            <div className="bg-gradient-to-r from-blue-900 to-blue-900 rounded-2xl p-8 md:p-12 text-white">
